...
const getAllpatients = () => {
  axios
    .get(`${Baseurl}employee/getPatient`, Auth())
    .then((res) => {
      ...
      <div className="top-div-personal">
        ...
        >
          <Form.Group className="mb-3">
            ...
            <Form.Select name='patientId' onChange={handleInputChange} aria-label="Default select example">
          ...
          <Form.Group className="mb-3">
            <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>
              Was Assistance in the self administration of medication completed?
            </Form.Label>
            <Form.Select
              onChange={handleInputChange}
          ...
          <Form.Group className="mb-3">
            ...
            >
              ...
              <option value="responding to internal stimuli">responding to internal stimuli</option>
              <option value=" inappropriate sexual comment"> inappropriate sexual comment</option>
          ...
          <Form.Group  className="mb-3">
            ...
            <Form.Check onChange={handleInputChange} name="religiousServices" type="checkbox" id={`Outings`} label="Outings" />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label> ADLS Completed</Form.Label>
            <Form.Select onChange={handleInputChange} name="adlsCompleted" aria-label="Default select example">
              <option>Select</option>
              <option value={true}>Yes</option>
              <option value={false}>No</option>
            </Form.Select>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Select onChange={handleInputChange} name="transportation" aria-label="Default select example">
              <option>Select</option>
              <option value={true}>Yes</option>
              <option value={false}>No</option>
            </Form.Select>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Select onChange={handleInputChange} name="residentRedirectedOnBehaviors" aria-label="Default select example">
              <option>Select</option>
              <option value={true}>Yes</option>
              <option value={false}>No</option>
            </Form.Select>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control onChange={handleInputChange} name="noteSummary" as={"textarea"} rows={3} placeholder="Enter  text" />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>BHT’s Name and Credentials:</Form.Label>
            <Form.Control
              onChange={handleInputChange} name="bhtNameAndCredentials"
              type="text"
              placeholder="Enter  text"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3 mt-5">
            ...
            <Form.Control
              type="text"
              placeholder="Enter text"
              onChange={handleInputChange} name="bhtSignature"
            />
          </Form.Group>
          <div
