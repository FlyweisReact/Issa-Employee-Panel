              ...
              <table className="colored_table">
                <thead>
                  <tr>
                    ...
                    <th className="text-start"> Appt</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-start">123 456 789</td>
                    <td className="text-start">5/15/23</td>
                    <td className="text-start">None</td>
                    <td className="text-start">Mercy Care RBHA</td>
                    <td className="text-start">DORO</td>
                  </tr>
                </tbody>
              </table>
            </div>
