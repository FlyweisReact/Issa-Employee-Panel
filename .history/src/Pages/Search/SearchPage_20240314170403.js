      ...
      <Container className="full-width-container">
        <div className="search-page">
          <h5 className="patient-name">
            <span>Patient:</span> {info?.data?.fullName}
          </h5>
                ...
                <div className="flex-container">
                  <div className="items">
                    <p>
                      ...
                      <span className="bold-one"> {IsPresent()}  {info?.data?.fullName} </span>
                    </p>
                    <p>
                  ...
                  <div className="items">
                    <p>
                      <span className="light-one">Gender Identity: </span>
                      <span className="bold-one"> {info?.data?.fullName} </span>
                    </p>
                    <p>
                      <span className="light-one">Company Name: </span>
                      <span className="bold-one">
                        {info?.data?.companyName}
                      </span>
                    </p>
                    <p>
                      <span className="light-one">Verified: </span>
                      <span className="bold-one">
                        {info?.data?.isVerified ? "Verified" : "Not Verified"}
                      </span>
                    </p>
                    <p>
