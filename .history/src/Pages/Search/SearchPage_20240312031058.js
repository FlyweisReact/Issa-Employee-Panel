      ...
      <Container className="full-width-container">
        <div className="search-page">
          <div className="tabs-list">
            <ul>
              <li onClick={() => setType("Documents")}>Info</li>
              <li onClick={() => setType("Documents")}>Documents</li>
              <li onClick={() => setType("Documents")}>Vitals</li>
              <li onClick={() => setType("Documents")}>Medications</li>
              <li onClick={() => setType("Documents")}>Intake</li>
              <li onClick={() => setType("Documents")}>Schedule</li>
            </ul>
          </div>
