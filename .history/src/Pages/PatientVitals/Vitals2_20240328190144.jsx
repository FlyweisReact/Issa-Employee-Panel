...
const Vitals2 = () => {
  ...
  const getAllpatients = () => {
    axios
      .get(`${process.env.React_App_Baseurl}employee/getPatient`, {
        headers: {
  ...
  const submitHandler = (e) => {
    ...
    axios
      .post(
        `${process.env.React_App_Baseurl}employee/createPatientVitals`,
        healthData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      .catch((err) => {
        showNotification({ message: err.response.data.message });
      });
  };
