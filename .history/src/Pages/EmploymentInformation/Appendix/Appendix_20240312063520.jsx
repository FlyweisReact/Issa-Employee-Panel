          ...
          <form className="w-100 text-start">
            ...
            >
              <div className="Radio_btns d-block">
                ...
                <label className="Show"> {spentMoreThan30DaysAbroad === true ? "YES I have been in a foreign country for >30 days (not including those listed above)" : "NO I have not been in any country for >30 days except the ones listed above"  } </label>
