...
const Appendix = () => {
  ...
  const handleDownload = () => {
    downloadReport2("report", "yourClassName");
  };
  return (
    <>
      <SignatureModal
      ...
      <Container className="full-width-container">
        <form className="w-100 text-start" onSubmit={handleSubmit} ref={ref}>
          <p className="fw-bold yourClassName">
      ...
      <div>
        <Container className="full-width-container print-container" ref={ref}>
          <form className="w-100 text-start">
            <p className="text-center fw-bold text-desc mt-5">OASIS NOTE</p>
            <p className="text-center fw-bold text-desc">Appendix 3</p>
            ...
            <div className="grid-container mb-3">
              ...
              <div className="grid-item full-wid-input">
                <label>Preferred Contact Information:</label>
                <label className="Show"> {preferredContactInformation} </label>
              </div>
              <div className="grid-item long-input">
                <label>1. What position are you hired for?</label>
                <label className="Show"> {positionHiredFor} </label>
              </div>
              <div className="grid-item long-input">
                <label>What is your start date?</label>
                <label className="Show"> {DateFormatter(startDate)} </label>
              </div>
              <div className="grid-item full-wid-input">
                <label>
                  2. Have you EVER spent more than 30 days in a country with an
              ...
              <div className="grid-item full-wid-input">
                <label>
                  {spentMoreThan30DaysAbroad === true
                    ? "YES I have been in a foreign country for >30 days (not including those listed above)"
              ...
              <div className="grid-item full-wid-input">
                <label>
                  {closeContactWithActiveTB === true ? "Yes" : "No"}{" "}
                </label>
              </div>
              <div className="grid-item full-wid-input">
                <label></label>
            ...
            >
              <div className="Radio_btns d-block">
                <span>
                  ...
                  had a positive skin test or a positive blood test for TB?
                </span>
                <div className="btns">
                  <RadioMaker
                    name="diagnosedWithLatentTB"
