...
const Personal = () => {
  ...
  return (
    <>
      ...
      <Container className="full-width-container">
        <form onSubmit={submitHandler} className="w-100 text-start">
          ...
          <button
            className="print_btn"
            type="button"
            onClick={() => downloadReport("PERSONNEL", "print_this")}
          >
            PRINT REPORT{" "}
          </button>
      ...
      <form className="w-100 text-start" id='print_this' style={{displa}}>
        <div className="grid-container mb-3">
          <div className="grid-item long-input" />
          <div className="grid-item" />
          <div className="grid-item">
        ...
        <div className="custome-cloud-btn">
          {savedSigned && (
            <p>
              Digitally Sign by {savedSigned} {signatureDate} {signatureTime}{" "}
            </p>
          )}
        </div>
      </form>
