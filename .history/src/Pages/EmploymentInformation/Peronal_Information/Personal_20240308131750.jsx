        ...
        <Container className="full-width-container" ref={ref}>
          <form onSubmit={submitHandler} className="w-100 text-start">
            <div className="grid-container mb-3">
              ...
              <div className="grid-item" />
              <div className="grid-item">
                <label>Date: {DateFormatter(date)} </label>
              </div>
              <div className="grid-item long-input print_this">
              ...
              <div className="grid-item full-wid-input">
                <label>Street: {addressStreet} </label>
              </div>
              <div className="grid-item long-input">
                <label>City: {addressCity} </label>
              
              </div>
              <div className="grid-item">
                <label>State: {addressState} </label>
              
              </div>
              <div className="grid-item">
                <label>Zip: {addressZip} </label>
                
              </div>
              <div className="grid-item long-input">
                <label>Soc Sec No: {socSecNo} </label>
              
              </div>
              <div className="grid-item long-input">
                <label>Birth Date: {DateFormatter(birthDate)} </label>
              ...
              <div className="grid-item long-input">
                <label>Home: {telephoneHome} </label>
             
              </div>
              <div className="grid-item long-input">
                <label>Personal Cell: {telephonePersonalCell} </label>
               
              </div>
              <div className="grid-item long-input">
                <label>Work: {telephoneWork} </label>
             
              </div>
              <div className="grid-item long-input">
                <label>Business Cell: {telephoneBusinessCell} </label>
              ...
              <div className="grid-item long-input">
                <label>State of Issue: {dLStateOfIssue} </label>
              
              </div>
              <div className="grid-item long-input">
                <label>No: {dLNumber} </label>
              
              </div>
              <div className="grid-item long-input">
                <label>Expiration Date: {DateFormatter(dLExpirationDate)} </label>
               
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Business Email: {businessEmail} </label>
                
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Personal Email: {personalEmail} </label>
              
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Emergency Contact: {emergencyContactName} </label>
             
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Relationship: {emergencyContactRelationship} </label>
               
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Emergency Contact Phone: {emergencyContactNumber} </label>
