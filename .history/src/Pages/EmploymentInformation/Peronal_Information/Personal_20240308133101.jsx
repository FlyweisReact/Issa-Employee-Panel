...
import { downloadReport, postApi } from "../../../Repository/Apis";
    ...
    <>
      ...
      <Container className="full-width-container" ref={ref}>
        <form onSubmit={submitHandler} className="w-100 text-start">
          ...
          <button className="print_btn" type="button" onClick={handleDownload}>
            PRINT REPORT
          </button>
      ...
      <div>
        <Container className="full-width-container" ref={ref}>
          <form onSubmit={submitHandler} className="w-100 text-start">
            <p className="text-center fw-bold " >EMPLOYEE PERSONNEL INFORMATION/EMERGENCY CONTACT</p>
            <div className="grid-container mb-3">
              <div className="grid-item long-input" />
              <div className="grid-item" />
              <div className="grid-item">
                <label>Date: </label>
                <label className="Show"> {DateFormatter(date)} </label>
              </div>
              <div className="grid-item long-input print_this">
                <label>Last Name:</label>
                <label className="Show"> {lastName} </label>
              </div>
              <div className="grid-item">
                <label>First:</label>
                <label className="Show"> {firstName} </label>
              </div>
              <div className="grid-item">
                <label>MI:</label>{" "}
                <label className="Show"> {middleInitial} </label>
              </div>
              <div className="grid-item full-wid-input">
                <label>Address:</label>
              </div>
              <div className="grid-item full-wid-input">
                <label>Street:</label>
                <label className="Show"> {addressStreet} </label>
              </div>
              <div className="grid-item long-input">
                <label>City:</label>
                <label className="Show"> {addressCity} </label>
              </div>
              <div className="grid-item">
                <label>State:</label>
                <label className="Show"> {addressState} </label>
              </div>
              <div className="grid-item">
                <label>Zip:</label>
                <label className="Show"> {addressZip} </label>
              </div>
              <div className="grid-item long-input">
                <label>Soc Sec No:</label>
                <label className="Show"> {socSecNo} </label>
              </div>
              <div className="grid-item long-input">
                <label>Birth Date:</label>
                <label className="Show"> {DateFormatter(birthDate)} </label>
              </div>
              <div className="grid-item full-wid-input">
                <label>Telephone:</label>
              </div>
              <div className="grid-item long-input">
                <label>Home:</label>
                <label className="Show"> {telephoneHome} </label>
              </div>
              <div className="grid-item long-input">
                <label>Personal Cell:</label>
                <label className="Show"> {telephonePersonalCell} </label>
              </div>
              <div className="grid-item long-input">
                <label>Work:</label>
                <label className="Show"> {telephoneWork} </label>
              </div>
              <div className="grid-item long-input">
                <label>Business Cell:</label>
                <label className="Show"> {telephoneBusinessCell} </label>
              </div>
              <div className="grid-item full-wid-input">
                <label>Driver’s License:</label>
              </div>
              <div className="grid-item long-input">
                <label>State of Issue:</label>
                <label className="Show"> {dLStateOfIssue} </label>
              </div>
              <div className="grid-item long-input">
                <label>No:</label>
                <label className="Show"> {dLNumber} </label>
              </div>
              <div className="grid-item long-input">
                <label>Expiration Date:</label>
                <label className="Show">
                  {" "}
                  {DateFormatter(dLExpirationDate)}{" "}
                </label>
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Business Email:</label>
                <label className="Show"> {businessEmail} </label>
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Personal Email:</label>
                <label className="Show"> {personalEmail} </label>
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Emergency Contact:</label>
                <label className="Show"> {emergencyContactName} </label>
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Relationship:</label>
                <label className="Show"> {emergencyContactRelationship} </label>
              </div>
              <div className="grid-item long-input"></div>
              <div className="grid-item long-input">
                <label>Emergency Contact Phone:</label>
                <label className="Show"> {emergencyContactNumber} </label>
              </div>
              <div className="grid-item long-input"></div>
            </div>
            <div className="custome-cloud-btn">
