      ...
      <Container className="full-width-container">
        <form onSubmit={submitHandler} className="w-100 text-start">
          ...
          <div className="custome-cloud-btn">
            ...
            <div>{savedSigned && <p>Digitally Sign by {savedSigned} {signatureDate} {signatureTime} </p>}</div>
          </div>

          <button className="print_btn" onClick={() => downloadReport("EMPLOYEE PERSONNEL INFORMATION/EMERGENCY CONTACT")} >PRINT REPORT </button>
