      ...
      <Container className="full-width-container">
        <form onSubmit={submitHandler} className="w-100 text-start" >
          <div className="grid-container mb-3">
            ...
            <div className="grid-item long-input print_this" ref={componentRef}>
              <label ref={componentRef}>Last Name:</label>
              <BorderlessInput
            ...
            <div className="grid-item">
              <label ref={componentRef}>First:</label>
              <BorderlessInput
          ...
          <button className="print_btn" type="button" onClick={handlePrint}>
            PRINT REPORT
          </button>
