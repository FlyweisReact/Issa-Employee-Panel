            ...
            <Container className="full-width-container" ref={ref}>
              <form className="w-100 text-start">
                ...
                <div className="grid-container mb-3">
                  ...
                  <div className="grid-item">
                    <label>Today's Date:</label>
                    <label className="Show"> {DateInMMDDYY(offerDate)} </label>
                  </div>
                  <div className="grid-item">
                    <label>Dear:</label>
                    <DefaultInput value={employeeName} isBots={false} />
                ...
                <p className="fw-bold">
                  ...
                  offer you the position of Behavior Health Technician. We trust
                  that this offer will be met with your approval. As per our
