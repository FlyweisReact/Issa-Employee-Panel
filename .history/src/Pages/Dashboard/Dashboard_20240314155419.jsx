...
const Dashboard = () => {
  ...
  const [ pastAppointmet , setPastAppointment ] = useState({})

  const fetchHandler = () => {
    getData(setPatients, "employee/getPatient");
    getData(setTodayAppointment, "employee/getAllTodayAppointments");
    getData(setPastAppointment, "employee/getAllPastAppointments");
  };


  console.log(pastAppointmet)
