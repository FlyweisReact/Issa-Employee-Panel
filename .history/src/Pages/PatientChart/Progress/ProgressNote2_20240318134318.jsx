        ...
        <form className="w-100 text-start" onSubmit={handleSubmit}>
          <div className="grid-container">
            ...
            <div className="grid-item full-wid-input d-block">
              ...
              <div className="Radio_btns">
                <div className="btns">
             <RadioMaker  name="residentRedirectedOnBehaviors"  setValue={setResidentRedirectedOnBehaviors} value={residentRedirectedOnBehaviors} id={"residentRedirectedOnBehaviors"} label={"yes"} checked={} />
                </div>
              </div>
            </div>
