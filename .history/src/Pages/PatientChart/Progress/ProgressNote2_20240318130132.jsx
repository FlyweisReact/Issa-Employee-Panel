...
const ProgressNote2 = () => {
  ...
  const pushInAppointment = (value) => {
    if (appointment.includes(value)) {
      const filtered = appointment.filter((item) => item !== value);
      setAppointment(filtered);
    } else {
      setAppointment([...appointment, value]);
    }
  };
          ...
          <div className="grid-container">
            ...
            <div className="grid-item full-wid-input">
              <div className="Radio_btns">
                <div className="btns">
                  name="appointmentNo" setValue={pushInAppointment}
                  value="NO" id="appointment1" label="NO" checked=
                  {appointment?.includes("NO")}
                  />
                  <RadioMakerNew
                    name="appointmentPCP"
                    setValue={pushInAppointment}
                    value="PCP"
                    id="appointment2"
                    label="PCP"
