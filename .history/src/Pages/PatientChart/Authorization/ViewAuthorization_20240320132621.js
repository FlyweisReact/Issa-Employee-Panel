        ...
        <form className="w-100 text-start">
          <div className="grid-container">
            <div className="grid-item long-input">
              ...
              <DefaultInput isBots={false} value={detail?.data?.residentName} />
            </div>
            ...
            <div className="grid-item full-wid-input">
              <label>
                ...
                writing to {detail?.data?.companyName} .This revocation will be
                effective except to the extent that action based on this
                authorization has already been taken. <br />
