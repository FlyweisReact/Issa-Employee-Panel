        ...
        <form className="w-100 text-start" onSubmit={submitHandler}>
          <div className="grid-container">
            ...
            <div className="grid-item">
              ...
              <DefaultInput value={details?.data?.familyMember} isBots={false} />
            </div>

            <div className="grid-item">
              <label>Doctors office</label>
              <DefaultInput value={details?.data?.doctorsOffice} isBots={false} />
            </div>
            ...
            <div className="grid-item long-input">
              ...
              <BorderlessInput
                ...
                type="text"
              />
              <DefaultInput value={details?.data?.personContactedOther} isBots={false} />
            </div>
            <div className="grid-item" />
            <div className="grid-item">
