        ...
        <form className="w-100 text-start" onSubmit={submitHandler}>
          <div className="grid-container">
            ...
            <div className="grid-item full-wid-input">
              ...
              <DefaultInput value={details?.data?.modeOfContactOther} isBots={false} />
            </div>

            <div className="grid-item full-wid-input">
              <DefaultInput value={details?.data?.contactSummaryNote} isBots={false} />
            </div>

            <div className="grid-item full-wid-input">
              <label>Emergency issue</label>
              <DefaultInput value={details?.data?.emergencyIssue ? "Yes" :"No"} isBots={false} />
