...
import { postApi, DateInMMDDYY, editApi } from "../../../Repository/Apis";
...
const UpdateContactNote = () => {
  ...
  useEffect(() => {
    if (details) {
      ...
      setSavedDate(item?.savedSigned);
      setSavedTime(item?.savedSigned);
    }
  }, [details]);
...
export default HOC(UpdateContactNote);
