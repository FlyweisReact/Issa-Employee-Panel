          ...
          <div className="grid-container">
            ...
            <div className="grid-item">
              ...
              <DefaultInput
                isBots={false}
                value={
                  details?.data?.data?.actionsTakenFirstAid
                    ? "Yes"
                    : "No"
                }
              />
            ...
            <div className="grid-item">
              ...
              <DefaultInput
                isBots={false}
                value={
                  details?.data?.data?.actionsTakenPoliceCalled
                    ? "Yes"
                    : "No"
                }
              />
            ...
            <div className="grid-item">
              ...
              <DefaultInput
                isBots={false}
                value={
                  details?.data?.data?.actionsTakenReferredtoAdministratorRiskManagement
                    ? "Yes"
                    : "No"
                }
              />
            ...
            <div className="grid-item">
              ...
              <DefaultInput
                isBots={false}
                value={
                  details?.data?.data?.actionsTakenMaintenanceCalledWorkOrderCompleted
                    ? "Yes"
                    : "No"
                }
              />
            ...
            <div className="grid-item">
              ...
              <DefaultInput
                isBots={false}
                value={
                  details?.data?.data?.actionsTakenOther
                    ? "Yes"
                    : "No"
                }
              />
