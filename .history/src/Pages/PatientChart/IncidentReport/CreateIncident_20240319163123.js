...
const CreateIncident = () => {
  ...
  return (
    <>
      ...
      />
      <NavWrapper title={"INCIDENT REPORT"} />
      ...
      <div>
        <div className="top-div-personal">
          <div className="selector">
            <button
              onClick={() => setType("PartI")}
              className={type === "PartI" && "active"}
              type="button"
            >
              Part I
            </button>
            <button
              onClick={() => setType("PartII")}
              className={type === "PartII" && "active"}
              type="button"
            >
              Part II
            </button>
          ...
          {type === "PartI" && (
            <Form onSubmit={submitHandler} className="w-100 text-start">
              ...
              <Form.Group className="mb-3 ">
                <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>
                  Describe the event in detail: What happened before, during,
          ...
          {type === "PartII" && (
            <Form className="w-100 text-start">
              ...
              <InputMaker label={"Completed By"} placeholder="" type={"text"} />
              <InputMaker label={"Date"} placeholder="" type={"date"} />
