        ...
        <form className="text-start w-100" onSubmit={submitHandler}>
          <div className="grid-container">
            <div className="grid-item">
              ...
              <DefaultInput isBots={false}  value={details?.data?.} />
              <select
            ...
            <div className="full-wid-input grid-item d-block">
              ...
              <div className="custome-cloud-btn">
                ...
                <div>
                  {residentSignature && (
                    <p>
                      Digitally Sign by {residentSignature}
                      {residentSignDate && DateInMMDDYY(residentSignDate)}{" "}
                      {residentSignTime}{" "}
                    </p>
                  )}
                </div>
                ...
                <div>
                  {staffSignature && (
                    <p>
                      ...
                      {staffSignDate && DateInMMDDYY(staffSignDate)}{" "}
                      {staffSignTime}{" "}
                    </p>
                  )}
                </div>
