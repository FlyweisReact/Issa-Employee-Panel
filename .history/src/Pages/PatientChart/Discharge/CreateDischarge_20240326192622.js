...
const CreateDischarge = () => {
  ...
  const [staffSignatureSaveAsDraft ,setStaffSignatureSaveAsDraft ] = useState(false)
  const [ bhpSignatureTime , setBhpSignatureTime ] = useState("")
  const [ bhpSignatureSaveAsDraft , setBhpSignature]
