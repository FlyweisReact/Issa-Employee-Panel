        ...
        <form className="text-start w-100">
          <div className="grid-container">
            ...
            <div className="grid-item">
              ...
              <DefaultInput value={DateInMMDDYY(data?.data?.dateOfAdmission)} isBots={false} />
            </div>
            ...
            <div className="grid-item">
              ...
              <BorderlessInput
                ...
                type="date"
              />
              <DefaultInput value={data?.data?.cliedateOfDischargedateOfDischargentName} isBots={false} />
            </div>
            <div className="grid-item third-wid-input" />
            <div className="grid-item">
