...
import { BorderlessSelect ,BorderlessInput  } from "../../../Helper/Makers";
      ...
      <Container className="full-width-container">
        <div className="grid-container">
          <div className="grid-item long-input">
            ...
            <BorderlessInput setState={setClientName} value={clientName} type='text' />
          </div>
          <div className="grid-item"></div>
          <div className="grid-item">
            <label>DOB:</label>
<BorderlessInput setState={} value={dateOfBirth} type='text' />
          </div>
        </div>
      </Container>
