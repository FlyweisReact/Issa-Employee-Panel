...
import { DateFormtter, PrintThis } from "../../../utils/utils";
  ...
  return (
    <>
      <div ref={componentRef}>
        <NavWrapper isArrow={} title={"Discharge Summary"} />
          ...
          <form className="text-start w-100">
            <div className="grid-container">
              ...
              <div className="grid-item">
                ...
                <DefaultInput
                  value={DateFormtter(data?.data?.dateOfBirth)}
                  isBots={false}
                />
              </div>
              ...
              <div className="grid-item">
                ...
                <DefaultInput
                  value={DateFormtter(data?.data?.dateOfAdmission)}
                  isBots={false}
                />
              </div>
              ...
              <div className="grid-item">
                ...
                <DefaultInput
                  value={DateFormtter(data?.data?.dateOfDischarge)}
                  isBots={false}
                />
              </div>
              <div className="grid-item third-wid-input" />
                  ...
                  {data?.data?.staffSignature && (
                    <>
                      ...
                      {data?.data?.staffSignatureDate &&
                        DateFormtter(data?.data?.staffSignatureDate)}
                    </>
                  )}
                </label>
              </div>
                  ...
                  {data?.data?.bhpSignature && (
                    <>
                      ...
                      {data?.data?.bhpSignatureDate &&
                        DateFormtter(data?.data?.bhpSignatureDate)}
                    </>
                  )}
                </label>
              </div>
