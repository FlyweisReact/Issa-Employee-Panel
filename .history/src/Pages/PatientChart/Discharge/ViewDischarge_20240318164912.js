          ...
          <div className="grid-container">
                ...
                {data?.data?.patientGuardianSignature && (
                  <>
                    ...
                    {data?.data?.patientGuardianSignatureDate &&
                      DateInMMDDYY(data?.data?.patientGuardianSignatureDate)}{" "}
                  </>
                )}
              </label>
            </div>
            ...
            <div className="grid-item full-wid-input d-block">
              ...
              {data?.data?.staffSignature && (
                    <>
                      Digitally Sign by {data?.data?.staffSignature}{" "}
                      {data?.data?.staffSignatureDate && DateInMMDDYY(data?.data?.staffSignatureDate)}
                     </>
                  )}
              </label>
            ...
            <div className="grid-item full-wid-input d-block">
              ...
              {data?.data?.bhpSignature && (
                    <>
                      Digitally Sign by {data?.data?.bhpSignature}{" "}
                      {data?.data?.bhpSignatureDate && DateInMMDDYY(data?.data?.bhpSignatureDate)}
                      {bhpTime}
                    </>
                  )}
              </label>
