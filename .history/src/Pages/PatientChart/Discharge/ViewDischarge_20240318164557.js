        ...
        <form className="text-start w-100">
          <div className="grid-container">
            ...
            <div className="grid-item">
              ...
              <DefaultInput value={data?.data?.presentingIssue} isBots={false} />
            </div>
            <div className="grid-item third-wid-input" />
            <div className="grid-item long-input">
              <label>Treatment Provided:</label>
          
              <DefaultInput value={data?.data?.treatmentProvided} isBots={false} />
            </div>
            <div className="grid-item long-input" />
            <div className="grid-item long-input">
            ...
            <div className="grid-item long-input">
              ...
              <DefaultInput value={data?.data?.medicationUponDischarge} isBots={false} />
            </div>
            <div className="grid-item long-input" />
            <div className="grid-item long-input">
              <label>Funds/Properties Upon Discharge:</label>
            
              <DefaultInput value={data?.data?.fundsPropertiesUponDischarge} isBots={false} />
            </div>
            <div className="grid-item long-input" />
            <div className="grid-item long-input">
              <label>Reason for Discharge:</label>
        
              <DefaultInput value={data?.data?.reasonForDischarge} isBots={false} />
            </div>
            <div className="grid-item long-input" />
            <div className="grid-item long-input">
              <label>Discharge Plan, Referral, and Aftercare Plan:</label>
         
              <DefaultInput value={data?.data?.dischargePlanReferralAftercarePlan} isBots={false} />
            </div>
            ...
            <div className="grid-item long-input">
              ...
              <DefaultInput value={data?.data?.staffNameAndTitle} isBots={false} />
            </div>
            ...
            <div className="grid-item long-input">
              ...
              <BorderlessInput
                ...
                type="text"
              />
              <DefaultInput value={data?.data?.bhpNameAndCredentials} isBots={false} />
            </div>
