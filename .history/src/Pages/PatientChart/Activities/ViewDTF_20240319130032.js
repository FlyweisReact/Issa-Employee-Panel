...
const ViewDTF = () => {
  ...
  const KeyPair = [
    {
      ...
      input: detail?.data?.selectingClothes?.requiresNoAssistance,
    },
    {
  ...
  useEffect(() => {
    if (detail) {
      ...
      setSomeAssistanceNeededSelectingClothes(
        item?.selectingClothes?.
      );
      setCompleteAssistanceNeededSelectingClothes(
        item?.selectingClothes?.
      );
      setNotApplicableSelectingClothes(item?.selectingClothes?.);
      setRefusedSelectingClothes(item?.selectingClothes?.);
      setStaffInitialsSelectingClothes(item?.selectingClothes?.);
