...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    ...
    // Hand Foot
    setRequiresNoAssistanceHandAndFootNailCare(item?.handAndFootNailCare?.requiresNoAssistance);
    setSomeAssistanceNeededHandAndFootNailCare(item?.handAndFootNailCare?.someAssistanceNeeded);
    setCompleteAssistanceNeededHandAndFootNailCare(item?.handAndFootNailCare?.completeAssistanceNeeded);
    setNotApplicableHandAndFootNailCare(item?.handAndFootNailCare?.notApplicable);
    setRefusedHandAndFootNailCare(item?.handAndFootNailCare?.refused);
    setStaffInitialsHandAndFootNailCare(item?.handAndFootNailCare?.staffInitials);
    // Bed Mobility
    setRequiresNoAssistanceHandAndFootNailCare(item?.bedMobility?.requiresNoAssistance);
    setSomeAssistanceNeededHandAndFootNailCare(item?.bedMobility?.someAssistanceNeeded);
    setCompleteAssistanceNeededHandAndFootNailCare(item?.bedMobility?.completeAssistanceNeeded);
    setNotApplicableHandAndFootNailCare(item?.bedMobility?.notApplicable);
    setRefusedHandAndFootNailCare(item?.bedMobility?.refused);
    setStaffInitialsHandAndFootNailCare(item?.bedMobility?.staffInitials);
