...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    ...
    setRequiresNoAssistancePMBowelMovement(item?.overnightBowelMovement?.requiresNoAssistance);
    setSomeAssistanceNeededPMBowelMovement(item?.overnightBowelMovement?.someAssistanceNeeded);
    setCompleteAssistanceNeededPMBowelMovement(item?.overnightBowelMovement?.completeAssistanceNeeded);
    setNotApplicablePMBowelMovement(item?.overnightBowelMovement?.notApplicable);
    setRefusedPMBowelMovement(item?.overnightBowelMovement?.refused);
    setStaffInitialsPMBowelMovement(item?.overnightBowelMovement?.staffInitials);
