        ...
        <form className="w-100 text-start">
          ...
          <div className="overflow-table">
            <table>
              <thead>
                <tr>
                  <th className="text-start">ADLS</th>
                  <th className="text-start">Requires No  Assistance</th>
                  <th className="text-start">Some  Assistance  Needed</th>
                  <th className="text-start">Complete  Assistance  Needed</th>
                  <th className="text-start">Not  Applicable</th>
                  <th className="text-start">Refused</th>
                  <th className="text-start">Staff Initials</th>
                </tr>
              </thead>
              <tbody>
                <tr>
