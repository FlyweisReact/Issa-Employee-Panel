...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      // laundry
      setRequiresNoAssistanceApplyingLotion(item?.laundry?.requiresNoAssistance);
      setSomeAssistanceNeededApplyingLotion(item?.laundry?.someAssistanceNeeded);
      setCompleteAssistanceNeededApplyingLotion(item?.laundry?.completeAssistanceNeeded);
      setNotApplicableApplyingLotion(item?.laundry?.notApplicable);
      setRefusedApplyingLotion(item?.laundry?.refused);
      setStaffInitialsApplyingLotion(item?.laundry?.staffInitials);
    }
  }, [detail]);
