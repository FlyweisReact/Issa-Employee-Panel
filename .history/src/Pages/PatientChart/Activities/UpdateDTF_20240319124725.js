...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    ...
    // Am Bowl Movement
    setRequiresNoAssistancePMSnack(item?.amBowelMovement?.requiresNoAssistance);
    setSomeAssistanceNeededPMSnack(item?.amBowelMovement?.someAssistanceNeeded);
    setCompleteAssistanceNeededPMSnack(item?.amBowelMovement?.completeAssistanceNeeded);
    setNotApplicablePMSnack(item?.amBowelMovement?.notApplicable);
    setRefusedPMSnack(item?.amBowelMovement?.refused);
    setStaffInitialsPMSnack(item?.amBowelMovement?.staffInitials);
