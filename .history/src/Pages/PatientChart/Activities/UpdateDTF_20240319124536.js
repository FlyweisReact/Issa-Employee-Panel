...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      // Am Snack
      setRequiresNoAssistanceDinner(item?.amSnacks?.requiresNoAssistance);
      setSomeAssistanceNeededDinner(item?.amSnacks?.someAssistanceNeeded);
      setCompleteAssistanceNeededDinner(item?.amSnacks?.completeAssistanceNeeded);
      setNotApplicableDinner(item?.amSnacks?.notApplicable);
      setRefusedDinner(item?.amSnacks?.refused);
      setStaffInitialsDinner(item?.amSnacks?.staffInitials);
