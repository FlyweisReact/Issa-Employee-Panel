...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    ...
    // Hand Foot
    setRequiresNoAssistanceOvernightBowelMovement(item?.handAndFootNailCare?.requiresNoAssistance);
    setSomeAssistanceNeededOvernightBowelMovement(item?.handAndFootNailCare?.someAssistanceNeeded);
    setCompleteAssistanceNeededOvernightBowelMovement(item?.handAndFootNailCare?.completeAssistanceNeeded);
    setNotApplicableOvernightBowelMovement(item?.handAndFootNailCare?.notApplicable);
    setRefusedOvernightBowelMovement(item?.handAndFootNailCare?.refused);
    setStaffInitialsOvernightBowelMovement(item?.handAndFootNailCare?.staffInitials);
