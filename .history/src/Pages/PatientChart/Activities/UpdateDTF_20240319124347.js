...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      // Breakfast
      setRequiresNoAssistanceLunch(item?.breakfast?.requiresNoAssistance);
      setSomeAssistanceNeededLunch(item?.breakfast?.someAssistanceNeeded);
      setCompleteAssistanceNeededLunch(item?.breakfast?.completeAssistanceNeeded);
      setNotApplicableLunch(item?.breakfast?.notApplicable);
      setRefusedLunch(item?.breakfast?.refused);
      setStaffInitialsLunch(item?.breakfast?.staffInitials);
