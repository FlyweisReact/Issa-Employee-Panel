...
const CreateDTF = () => {
  ...
  const [completeAssistanceNeededPMSnack, setCompleteAssistanceNeededPMSnack] =
    useState(true);
  const [notApplicablePMSnack, setNotApplicablePMSnack] = useState(true);
  const [refusedPMSnack, setRefusedPMSnack] = useState(true);
  ...
  const [notApplicableAMBowelMovement, setNotApplicableAMBowelMovement] =
    useState(true);
  const [refusedAMBowelMovement, setRefusedAMBowelMovement] = useState(true);
  ...
  const [notApplicablePMBowelMovement, setNotApplicablePMBowelMovement] =
    useState(true);
  const [refusedPMBowelMovement, setRefusedPMBowelMovement] = useState(true);
  ...
  const [notApplicableBedMobility, setNotApplicableBedMobility] =
    useState(true);
  const [refusedBedMobility, setRefusedBedMobility] = useState(true);
  ...
  return (
    <>
      ...
      />
      <NavWrapper title={"Activities of Daily Living Tracking Form"} isArrow />
