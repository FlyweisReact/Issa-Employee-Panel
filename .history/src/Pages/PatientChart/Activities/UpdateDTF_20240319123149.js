...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      setRequiresNoAssistanceSelectingClothes(item?.selectingClothes?.someAssistanceNeeded);
      setRequiresNoAssistanceSelectingClothes(item?.selectingClothes?.completeAssistanceNeeded);
      setRequiresNoAssistanceSelectingClothes(item?.selectingClothes?.notApplicable);
      setRequiresNoAssistanceSelectingClothes(item?.selectingClothes?.refused);
      setRequiresNoAssistanceSelectingClothes(item?.selectingClothes?.staffInitials);
    }
  }, [detail]);
