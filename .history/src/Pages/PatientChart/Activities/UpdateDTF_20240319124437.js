...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      // Dinner
      setRequiresNoAssistanceBreakfast(item?.dinner?.requiresNoAssistance);
      setSomeAssistanceNeededBreakfast(item?.dinner?.someAssistanceNeeded);
      setCompleteAssistanceNeededBreakfast(item?.dinner?.completeAssistanceNeeded);
      setNotApplicableBreakfast(item?.dinner?.notApplicable);
      setRefusedBreakfast(item?.dinner?.refused);
      setStaffInitialsBreakfast(item?.dinner?.staffInitials);
