...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      // Lunch
      setRequiresNoAssistanceOralCareMorning(item?.lunch?.requiresNoAssistance);
      setSomeAssistanceNeededOralCareMorning(item?.lunch?.someAssistanceNeeded);
      setCompleteAssistanceNeededOralCareMorning(item?.lunch?.completeAssistanceNeeded);
      setNotApplicableOralCareMorning(item?.lunch?.notApplicable);
      setRefusedOralCareMorning(item?.lunch?.refused);
      setStaffInitialsOralCareMorning(item?.lunch?.staffInitials);
