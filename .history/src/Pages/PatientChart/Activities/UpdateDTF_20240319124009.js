...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      // Oral Care Evening
      setRequiresNoAssistanceOralCareEvening(item?.oralCareMorning?.requiresNoAssistance);
      setSomeAssistanceNeededOralCareEvening(item?.oralCareMorning?.someAssistanceNeeded);
      setCompleteAssistanceNeededOralCareEvening(item?.oralCareMorning?.completeAssistanceNeeded);
      setNotApplicableOralCareEvening(item?.oralCareMorning?.notApplicable);
      setRefusedOralCareEvening(item?.oralCareMorning?.refused);
      setStaffInitialsOralCareEvening(item?.oralCareMorning?.staffInitials);
