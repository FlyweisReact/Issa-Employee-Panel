...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    ...
    //  Pm Snack
    setRequiresNoAssistanceAMSnack(item?.pmSnack?.requiresNoAssistance);
    setSomeAssistanceNeededAMSnack(item?.pmSnack?.someAssistanceNeeded);
    setCompleteAssistanceNeededAMSnack(item?.pmSnack?.completeAssistanceNeeded);
    setNotApplicableAMSnack(item?.pmSnack?.notApplicable);
    setRefusedAMSnack(item?.pmSnack?.refused);
    setStaffInitialsAMSnack(item?.pmSnack?.staffInitials);
