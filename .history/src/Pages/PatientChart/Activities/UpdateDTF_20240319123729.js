...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      // Dressing
      setRequiresNoAssistanceLaundry(item?.dressing?.requiresNoAssistance);
      setSomeAssistanceNeededLaundry(item?.dressing?.someAssistanceNeeded);
      setCompleteAssistanceNeededLaundry(item?.dressing?.completeAssistanceNeeded);
      setNotApplicableLaundry(item?.dressing?.notApplicable);
      setRefusedLaundry(item?.dressing?.refused);
      setStaffInitialsLaundry(item?.dressing?.staffInitials);
