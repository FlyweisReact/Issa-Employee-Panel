...
const UpdateDTF = () => {
  ...
  useEffect(() => {
    ...
    // Pm Bowl Movement
    setRequiresNoAssistanceAMBowelMovement(item?.pmBowelMovement?.requiresNoAssistance);
    setSomeAssistanceNeededAMBowelMovement(item?.pmBowelMovement?.someAssistanceNeeded);
    setCompleteAssistanceNeededAMBowelMovement(item?.pmBowelMovement?.completeAssistanceNeeded);
    setNotApplicableAMBowelMovement(item?.pmBowelMovement?.notApplicable);
    setRefusedAMBowelMovement(item?.pmBowelMovement?.refused);
    setStaffInitialsAMBowelMovement(item?.pmBowelMovement?.staffInitials);
