    ...
    if (query) {
      filteredData = filteredData?.filter(
        (i) =>
          ...
          i?.mobileNumber?.toString()?.includes(query?.toLowerCase()) ||
      ...
      <div className="search-container">
        <div className="item">
          ...
          <input
            ...
            placeholder="Name, Phone Number , Email Id"
          />
        </div>
        <div className="item">
          <p>Filter:</p>
            ...
            <tbody>
              {filterData()?.map((i, index) => (
                <tr key={index}>
                  ...
                  <td>
                  <a href={'https://issa-patient-update-website.vercel.app/'} style={boldStyle} target={'_blank'}>
                  Intake
                  </a>
                    <Link to={`/patient-list/intake`} >
