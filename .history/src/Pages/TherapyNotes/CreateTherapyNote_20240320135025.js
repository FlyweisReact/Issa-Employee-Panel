...
import { BorderlessInput, DateFormatter, InputMaker, MultiSelect, RadioMaker } from "../../Helper/Makers";
...
const CreateTherapyNote = () => {
  ...
  return (
    ...
    <div className="grid-item">
        ...
        <BorderlessInput setState={setDate} value={DateFormatter(date} type='date' />
    </div>
