...
const Login = () => {
  ...
  const handleForget = async (e) => {
    ...
    if (showOtp) {
      try {
        const res = await axios.post(`${process.env.React_App_Baseurl}employee/forgotVerifyOtp`, {
          email,
          otp,
        });
      ...
      try {
        const res = await axios.post(`${process.env.React_App_Baseurl}employee/forgetPassword`, {
          email,
        });
