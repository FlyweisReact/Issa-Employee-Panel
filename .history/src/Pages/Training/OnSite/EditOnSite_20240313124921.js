...
const EditOnSite = () => {
  ...
  const fetchHandler = () => {
    getData(setData, "employee/getOnSiteFacilityById");
  };
                ...
                <div>
                  {employeeSignature && (
                    <p>
                      ...
                      {DateInMMDDYY(employeePropsDate)} {employeeTime}{" "}
                    </p>
                  )}
                </div>
              </div>
                ...
                <div>
                  {trainerSignature && (
                    <p>
                      ...
                      {DateInMMDDYY(trainerPropsDate)} {trainerTime}{" "}
                    </p>
                  )}
                </div>
              </div>
