...
import { Form, Button, Container } from "react-bootstrap";import { getData } from "../../../components/api/api";
...
const Skills2 = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    postApi(setLoading, "employee/createSkillAndKnowledge", payload);
  };
  ...
  return (
    <>
      <SignatureModal
        ...
        setValue={setVerifiedBySignature}
        value={verifiedBySignature}
        setTime={setVerifyModTime}
        setDate={setVerifyModDate}
      />
      <SignatureModal
        show={open}
        ...
        setTime={setEmployeeModTime}
        setDate={setEmployeeModDate}
      />
      ...
      <Container className="full-width-container">
        ...
        <div className="grid-container">
          <div className="grid-item third-wid-input">
            ...
            <BorderlessSelect
              options={options2}
              setState={setVerificationMethod}
