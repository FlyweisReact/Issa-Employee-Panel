...
const Skills2 = () => {
  ...
  const [hoursCompleted, setHoursCompleted] = useState(20);
  ...
  const [verificationMethod, setVerificationMethod] =
    useState("Visual observation");
  const [employeeSignature, setEmployeeSignature] =
    useState("John's Signature");
  const [employeeTitle, setEmployeeTitle] = useState("Developer");
  const [employeeDate, setEmployeeDate] = useState("2023-12-18");
  const [verifiedBySignature, setVerifiedBySignature] = useState(
    "Verifier's Signature"
  );
  const [verifiedByTitle, setVerifiedByTitle] = useState("Manager");
  const [verifiedByDate, setVerifiedByDate] = useState("2023-12-18");
  return (
    <>
      <div className="nav-wrap-personal">
        ...
        >
          ...
          <p>
            {" "}
            <Button onClick={() => navigate("/employee/training/skills")}>
              + NEW
            </Button>
          </p>
        </div>
