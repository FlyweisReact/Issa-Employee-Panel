        ...
        <div className="medication">
          ...
          <div className="two-boxes">
            <div className="instructions">
              <div className="name">
                <p> Medication name: Example Ibuprofen</p>
                <p>Take 1 tab by mouth daily</p>
                <p>Take 1 tab twice daily</p>
                <p>Take 1 tab by mouth three times daily</p>
                <p>Take 1 tab by mouth 4 times daily</p>
                <p>Take 1 tab by mouth at bedtime</p>
                <p>Take 1/2 tab by mouth daily</p>
                <p>Take ½ tab by mouth twice daily</p>
                <p>Take ½ tab by mouth three times daily</p>
                <p>Dissolve 1 tab under the tongue daily</p>
                <p>Dissolve 1 tab under the tongue at</p>
                <p>bedtime
Take 1 tab by mouth on empty stomach
one (1) hour before breakfast</p>
