        ...
        <div className="medication">
          <div className="grid-container">
            ...
            <div className="grid-item">
              <label>
              Month/Year:{" "}
                {patientData?.data?.month}/{patientData?.data?.year}
              </label>
            </div>
            ...
            <div className="grid-item">
              <label>Psychiatric Provider: {patientData?.data?.psychiatricProvider} </label>
            </div>
            <div className="grid-item">
            ...
            <div className="grid-item">
              <label>Fluid restriction: {patientData?.data?.fluidRestriction} </label>
            </div>
            <div className="grid-item full-wid-input">
...
Take 1 tab by mouth three times daily
Take 1 tab by mouth 4 times daily
Take 1 tab by mouth at bedtime
Take 1/2 tab by mouth daily
Take ½ tab by mouth twice daily
Take ½ tab by mouth three times daily
Dissolve 1 tab under the tongue daily
Dissolve 1 tab under the tongue at
bedtime
Take 1 tab by mouth on empty stomach
one (1) hour before breakfast
              </div>
            </div>
