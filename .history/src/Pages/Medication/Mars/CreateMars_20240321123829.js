...
//   ---
const [employeeId, setEmployeeId] = useState("6572bffbdc2becf40ab7af9d");
const [patientId, setPatientId] = useState("6572c1ffd4a09e03c1c57f50");
const [admitDate, setAdmitDate] = useState("2024-01-27");
const [month, setMonth] = useState("01");
const [year, setYear] = useState("2024");
const [location, setLocation] = useState("fddf");
const [psychiatricProvider, setPsychiatricProvider] = useState("dfdf");
const [pcpProvider, setPcpProvider] = useState("fddf");
const [diet, setDiet] = useState("fddaf");
const [fluidRestriction, setFluidRestriction] = useState("");
const [allergies, setAllergies] = useState("fdadf");
const [medicationsId, setMedicationsId] = useState(["65990581682bdb269ecfd98c"]);
const [instruction, setInstruction] = useState([
  ["Take 1 tab by mouth three times daily", "Take 1 tab by mouth at bedtime"]
]);
const [time, setTime] = useState(["08:00 AM", "02:00 PM"]);
