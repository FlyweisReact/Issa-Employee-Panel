...
const Reconciliation = () => {
    ...
    const url = `employee/getAllMedicationReconciliation?patientId=${patientId}&allergiesAndReactions=${allergiesAndReactions}`

    const getAllData = () => {
        fetchApi(setLoading , "employee/getAllMedicationReconciliation" ,setData )
      axios
