...
export const SignatureModal = (props) => {
  ...
  const originalDateInSeconds = Math.floor(today.getTime() / 1000); // Convert milliseconds to seconds
  console.log(originalDateInSeconds);
    ...
    <>
      ...
      >
        ...
        <Modal.Body className="singature_modal">
          ...
          <h6> Date : {originalDateInSeconds} </h6>
          <input
            type="text"
