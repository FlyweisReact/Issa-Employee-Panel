                  ...
                  return (
                    <li>
                      <Link to={nav.link} key={nav.name}>
                        {imgFetcher(nav.newIcon, nav.icon)}
                        {/* <span className="image-wrapper">{nav.newIcon}</span>
                        <span className="outline_wrapper">{nav.icon}</span> */}
