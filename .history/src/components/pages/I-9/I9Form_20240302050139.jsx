...
export const I9Form = () => {
  ...
  const [alternativeProcedureUsed, setAlternativeProcedureUsed] =
    ...
    const [employerName, setEmployerName] = useState("ABC ");
    const [employerTitle, setEmployerTitle] = useState("HR Manager");
    const [employerSignature, setEmployerSignature] = useState("HR Signature");
    const [employerDate, setEmployerDate] = useState("2023-01-02");
    const [businessName, setBusinessName] = useState("ABC Corp");
    const [businessCity, setBusinessCity] = useState("Anytown");
    const [businessState, setBusinessState] = useState("CA");
    const [businessZipCode, setBusinessZipCode] = useState("12345");
