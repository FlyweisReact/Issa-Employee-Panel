      ...
      <Container className="full-width-container">
        <form className="w-100 text-start" onSubmit={submitHandler}>
          ...
          <p className="fw-bold text-desc text-center">
            ...
            <br /> * Documents extended by the issuing authority are considered
            unexpired. <br /> Employees may present one selection from List A or
            a <br />
            combination of one selection from List B and one selection from List
            C. <br /> Examples of many of these documents appear in the Handbook
            for Employers (M-274).{" "}
          </p>
