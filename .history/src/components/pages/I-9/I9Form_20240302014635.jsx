...
export const I9Form = () => {
  ...
  // citizenshipDetails
  const [usCisNumber, setUsCisNumber] = useState("USCIS12345");
  const [i94Number, setI94Number] = useState("I94ABC");
  const [foreignPassportNumber, setForeignPassportNumber] = useState("Passport123");
  const [countryOfIssuance, setCountryOfIssuance] = useState("CountryXYZ");
