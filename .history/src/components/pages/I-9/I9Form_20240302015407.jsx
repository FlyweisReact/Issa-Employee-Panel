    ...
    <>
      ...
      <Container className="full-width-container">
        <form className="w-100 text-start" onSubmit={submitHandler}>
          ...
          <p className="fw-bold text-desc">
          If a preparer and/or translator assisted you in completing Section 1, that person MUST complete the <a href='https://www.uscis.gov/i-9' target='_blank'>
            
          </a> Preparer and/or Translator Certification on Page 3. 
