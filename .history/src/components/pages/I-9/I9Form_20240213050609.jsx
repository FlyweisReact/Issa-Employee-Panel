        ...
        >
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              verify information in Section 1, or specify which acceptable
              documentation employees must present for Section 2 or Supplement
              B, Reverification and Rehire. Treating employees differently based
              on their citizenship, immigration status, or national origin may
              be illegal.
            </span>
          </p>
          ...
          <div key={"radio"} className="mb-3">
            ...
            <Form.Check type={"radio"} id={`check-api-${"radio"}`}>
              ...
              <Form.Check.Label>
                {" "}
                <p>3. A lawful permanent resident (Enter USCIS or A-Number.)</p>
              </Form.Check.Label>
            </Form.Check>
          </div>
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              must physically examine, or examine consistent with an alternative
              procedure authorized by the Secretary of DHS, documentation from
              List A OR a combination of documentation from List B and List C.
              Enter any additional documentation in the Additional Information
          ...
          <Form.Group className="mb-3">
            ...
            >
              Employer's Business or Organization Address, City or Town, State,
              ZIP Code:
            </Form.Label>
            <Form.Control type="text" placeholder="Enter  text" />
          </Form.Group>
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            combination of one selection from List B and one selection from List
            C.
          </p>
          <p>
          ...
          <p style={{ fontWeight: "500" }}>
            1. U.S. Passport or U.S. Passport Card <br /> 2. Permanent Resident
            Card or Alien Registration Receipt Card (Form I-551) <br />
            ...
            <br /> 6. Passport from the Federated States of Micronesia (FSM) or
            the Republic of the Marshall Islands (RMI) with Form I-94 or Form
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            name, date of birth, gender, height, eye color, and address <br />
            ...
            <br /> 9. Driver's license issued by a Canadian government authority
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            <br /> 3. Original or certified copy of birth certificate issued by
            a State, county, municipal authority, or territory of the United
            States bearing an official seal <br />
            ...
            Homeland Security For examples, see Section 7 and Section 13 of the
            M-274 on uscis.gov/i-9-central. <br />
            The Form I-766, Employment Authorization Document, is a List A, Item
          ...
          <p style={{ textAlign: "center" }}>
            {" "}
            May be presented in lieu of a document listed above for a temporary
            period. For receipt validity dates, see the M-274.
          </p>
          <p>
            <li>
              {" "}
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              translator who assists an employee in completing Section 1 of Form
              I-9. The preparer and/or translator must enter the employee's name
              in the spaces provided above. Each preparer or translator must
          ...
          <p>
            ...
            and if the employee presented documentation, the documentation I
            examined appears to be genuine and to relate to the individual who
            presented it.
          </p>
          ...
          <p>
            Reverification:{" "}
            <span style={{ fontWeight: "500" }}>
              If the employee requires reverification, your employee can choose
              to present any acceptable List A or List C documentation to show
