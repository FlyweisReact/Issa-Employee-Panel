            ...
            <div className="grid-item full-wid-input d-block">
              ...
              <div>
                <CheckBoxMaker
                  ...
                  checked={
                    citizenshipStatus === "A citizen of the United States"
                  }
                  id={"citizenshipStatus1"}
                />
                <CheckBoxMaker
                  setValue={setCitizenshipStatus}
                  value={"A noncitizen national of the United States (See Instructions.)"}
                  label={"2.  A noncitizen national of the United States (See Instructions.)"}
                  checked={
                    citizenshipStatus === "A noncitizen national of the United States (See Instructions.)"
                  }
                  id={"citizenshipStatus2"}
                />{" "}
                <CheckBoxMaker
                  setValue={setCitizenshipStatus}
                  value={"A lawful permanent resident (Enter USCIS or A-Number."}
                  label={"3. A citizen of the United States"}
                  checked={
                    citizenshipStatus === "A citizen of the United States"
                  }
                  id={"citizenshipStatus1"}
