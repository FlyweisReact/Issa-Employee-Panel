...
const Employment = () => {
  ...
  return (
    <div className="main-div-employment">
      ...
      <div>
        <img
          onClick={() => navigate("/aps-consent-form")}
          src="/Employment/APS_Consent.png"
          alt="Employment"
        />
      </div>
      <div>
        <img onClick={() => navigate("/termination")} src="/Employment/Termination.png" alt="Employment" />
      </div>
      <div>
        <img onClick={() => navigate("/fw9")} src="/Employment/fw9.png" alt="Employment" />
      </div>
      <div>
        <img onClick={() => navigate("/i-9")} src="/Employment/i-9.png" alt="Employment" />
      </div>
    </div>
  );
};
