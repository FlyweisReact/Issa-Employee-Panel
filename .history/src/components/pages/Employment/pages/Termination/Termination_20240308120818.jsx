        ...
        >
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              required
              onChange={(e) =>
                updateField("terminatedEmployeeName", e.target.value)
              }
              type="text"
              placeholder="Enter  name"
            />
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Select
              required
              onChange={(e) => updateField("involuntaryReason", e.target.value)}
            >
              <option value="">Select</option>
              ...
              <option value="Absenteeism or Tardiness">
          ...
          <Form.Group className="mb-3">
            ...
            >
              ...
              <div
                onChange={(e) =>
                  updateField("disciplinaryAction", e.target.value)
                }
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                <Form.Check type={"radio"} id={`check-api-night-sweats-yes`}>
                  <Form.Check.Input
                    onChange={(e) =>
                      setFormData({ ...formData, copyProvided: "Employee" })
                    }
                    name="r1"
                    type={"radio"}
                    isValid
                ...
                >
                  <Form.Check.Input
                    onChange={(e) =>
                      setFormData({ ...formData, copyProvided: "Other" })
                    }
                    name="r1"
                    type={"radio"}
                    isValid
          ...
          <Form.Group className="mb-3">
            ...
            >
              ...
              <div
                onChange={(e) =>
                  updateField("eligibleForRehire", e.target.value)
                }
                style={{ display: "flex", alignItems: "center" }}
              >
                <Form.Check
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              required
              onChange={(e) => updateField("employeeSignature", e.target.value)}
              type="text"
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              onChange={(e) =>
                updateField("administratorSignature", e.target.value)
              }
              type="text"
            />
          </Form.Group>
...
export default HOC({ Wcomponenet: Termination, isNavbar: false });
