...
export const FW9 = () => {
  ...
  const content = {
    ...
    secondItem: [
      ...
      {
        para: "Enter your TIN in the appropriate box. If you are a resident alien and  you do not have and are not eligible to get an SSN, your TIN is your IRS individual taxpayer identification number (ITIN). Enter it in the social 
        ",
        status: "heading",
      },
    ],
