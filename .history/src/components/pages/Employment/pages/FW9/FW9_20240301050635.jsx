...
export const FW9 = () => {
  ...
  const [businessName, setBusinessName] = useState("XYZ Corp");
  const [taxClassification, setTaxClassification] = useState("Individual");
  const [llcTaxClassification, setLLCTaxClassification] = useState("C");
  const [other, setOther] = useState("Some value");
  const [exemptionsPayeeCode, setExemptionsPayeeCode] = useState("Exempt");
  const [exemptionsFatCaExemptionCode, setExemptionsFatCaExemptionCode] = useState("SomeCode");
  ...
  const [requesterAddress, setRequesterAddress] = useState("Requester Address");
  const [accountNumbers, setAccountNumbers] = useState(["Account1", "Account2"]);
  const [tinSsn, setTinSsn] = useState("123-45-6789");
  const [tinEin, setTinEin] = useState("12-3456789");
  const [certificationIsCorrectTIN, setCertificationIsCorrectTIN] = useState(true);
  const [certificationIsExemptFromBackupWithholding, setCertificationIsExemptFromBackupWithholding] = useState(false);
  const [certificationIsUSPerson, setCertificationIsUSPerson] = useState(true);
  const [certificationFatCaCodes, setCertificationFatCaCodes] = useState("FATCA123");
