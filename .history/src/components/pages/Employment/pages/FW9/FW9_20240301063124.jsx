...
export const FW9 = () => {
  ...
  const content = {
    firstItem: [
      ...
      {
        status: "table",
        parent: ["IF the payment is for" , "Interest and dividend payments" , "Broker transactions" , "Barter exchange transactions and  patronage dividends" , "Payments over $600 required to be
