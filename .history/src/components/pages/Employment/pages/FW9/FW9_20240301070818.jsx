...
export const FW9 = () => {
  ...
  const content = {
    firstItem: [
      ...
      },
      {
        ...
        parent: {
          ...
          body: [
            ...
            {
              first:"10. Corporation or LLC electing corporate status on Form 8832 or Form 2553",
              second:"The corporation",
            },
            {
              first:"11. Association, club, religious, charitable, educational, or other taxexempt organization",
      ...
      ,{
        para : "The IRS does not initiate contacts with taxpayers via emails. Also, the
