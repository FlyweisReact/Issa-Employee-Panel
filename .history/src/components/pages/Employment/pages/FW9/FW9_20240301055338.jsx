...
export const FW9 = () => {
  ...
  const content = {
    firstItem: [
      ...
      {
        para: "By signing the filled-out form, you: 1. Certify that the TIN you are giving is correct (or you are waiting for a number to be issued), 2. Certify that you are not subject to backup withholding, or
