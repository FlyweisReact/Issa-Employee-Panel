...
import { BorderlessInput, CheckBoxMaker } from "../../../../../Helper/Makers";
          ...
          <div className="grid-container">
            ...
            <div className="grid-item full-wid-input">
              <label>
                ...
                am waiting for a number to be issued to me); and <br /> 2. I am not
                ...
                subject to backup withholding; and 3. I am a U.S. citizen or
                other U.S. person (defined below); and 4. The FATCA code(s)
                entered on this form (if any) indicating that I am exempt from
                FATCA reporting is correct. Certification instructions. You must
                cross out item 2 above if you have been notified by the IRS that
