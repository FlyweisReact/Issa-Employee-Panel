...
export const FW9 = () => {
  ...
  const content = {
    firstItem: [
      ...
      {
        para : "1 See Form 1099-MISC, Miscellaneous Income, and its instructions.  2 However, the following payments made to a corporation and  reportable on Form 1099-MISC are not exempt from backup
