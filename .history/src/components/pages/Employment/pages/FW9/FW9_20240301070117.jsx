      ...
      },
      {
        ...
        parent: {
          ...
          body: [
            ...
            {
              first: "2. Two or more individuals (joint account) other than an account  maintained by an FFI",
              second: "The actual owner of the account or, if combined funds, the first individual on the account",
            },
            {
              first: "3. Two or more U.S. persons  (joint account maintained by an FFI,  Each holder of the account ",
            },
            {
              first:  "4. Custodial account of a minor (Uniform Gift to Minors Act)  ",
              second: "The minor2 ",
            },
            {
              first:
