      ...
      <div className="nav-wrap-personal">
        ...
        <div className="nav-div-personal">
          <p style={{ fontSize: ".9rem", fontWeight: "bold" }}>
            REQUEST FOR TAXPAYER IDENTIFICATION NUMBER AND CERTUFUCATION
          </p>
        </div>
      </div>
      <div className="top-div-personal">
        ...
        >
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            an information return with the IRS must obtain your correct taxpayer
            ...
            you, or other amount reportable on an information return. Examples
            of information returns include, but are not limited to, the
            following.
          </p>
          <p style={{ fontWeight: "500" }}>
          ...
          <p style={{ fontWeight: "500" }}>
            By signing the filled-out form, you: <br /> 1. Certify that the TIN
            ...
            payee. If applicable, you are also certifying that as a U.S. person,
            ...
            share of effectively connected income, and
            <br /> 4. Certify that FATCA code(s) entered on this form (if any)
            indicating that you are exempt from the FATCA reporting, is correct.
            See What is FATCA reporting, later, for further information.
            <br /> <span style={{ fontWeight: "bold" }}>Note:</span> If you are
            a U.S. person and a requester gives you a form other than Form W-9
            ...
            <br />• A partnership, corporation, company, or association created
            or organized in the United States or under the laws of the United
            States; <br />• An estate (other than a foreign estate); or <br />•
            ...
            to establish your U.S. status and avoid section 1446 withholding on
            your share of partnership income. <br />
            <br />
            ...
            owner of the disregarded entity and not the entity; • In the case of
            a grantor trust with a U.S. grantor or other U.S. owner, generally,
            the U.S. grantor or other U.S. owner of the grantor trust and not
            the trust; and
            ...
            or Form 8233 (see Pub. 515, Withholding of Tax on Nonresident Aliens
            ...
            permit an exemption from tax to continue for certain types of income
            even after the payee has otherwise become a U.S. resident alien for
            tax purposes.
            <br /> If you are a U.S. resident alien who is relying on an
            exception contained in the saving clause of a tax treaty to claim an
            exemption from U.S. tax on certain types of income, you must attach
            a statement to Form W-9 that specifies the following five items.{" "}
            <br />
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            Persons making certain payments to you must under certain conditions
            withhold and pay to the IRS 24% of such payments. This is called
            “backup withholding.” Payments that may be subject to backup
            withholding include interest, tax-exempt interest, dividends, broker
            and barter exchange transactions, rents, royalties, nonemployee pay,
            payments made in settlement of payment card and third party network
            transactions, and certain payments from fishing boat operators. Real
            ...
            not certify your TIN when required (see the instructions for Part II
            for details), <br /> 3. The IRS tells the requester that you
            furnished an incorrect TIN, <br /> 4. The IRS tells you that you are
            subject to backup withholding because you did not report all your
            interest and dividends on your tax return (for reportable interest
            and dividends only), or <br /> 5. You do not certify to the
            requester that you are not subject to backup withholding under 4
            above (for reportable interest and dividend accounts opened after
            1983 only). <br /> Certain payees and payments are exempt from
            ...
            Also see Special rules for partnerships, earlier. <br />
          </p>
          <p style={{ fontWeight: "500" }}>
            <span style={{ fontWeight: "bold" }}>What is FATCA Reporting?</span>{" "}
            <br />
            ...
            FATCA reporting code, later, and the Instructions for the Requester
            of Form W-9 for more information. <br />
            <span style={{ fontWeight: "bold" }}>
            ...
            you no longer are tax exempt. In addition, you must furnish a new
            Form W-9 if the name or TIN changes for the account; for example, if
            the grantor of a grantor trust dies. <br />
            ...
            neglect. Civil penalty for false information with respect to
            withholding. If you make a false statement with no reasonable basis
            that results in no backup withholding, you are subject to a $500
            penalty.
          </p>
          <p>
            <span style={{ fontWeight: "bold" }}>
            ...
            to criminal penalties including fines and/or imprisonment. Misuse of
            TINs. If the requester discloses or uses TINs in violation of
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            line blank. The name should match the name on your tax return. If
            ...
            FFI to document a joint account, each holder of the account that is
            ...
            Administration (SSA) of the name change, enter your first name, the
            last name as shown on your social security card, and your new last
            name. <br />{" "}
            <span style={{ fontWeight: "bold" }}>Note: ITIN applicant:</span>
            <br /> Enter your individual name as it was entered on your Form W-7
            application, line 1a. This should also be the same as the name you
            entered on the Form 1040/1040A/1040EZ you filed with your
            application. <br />{" "}
            <span style={{ fontWeight: "bold" }}>
            ...
            1 and any business, trade, or DBA name on line 2. <br />
            ...
            entity separate from its owner is treated as a “disregarded entity.”
            See Regulations section 301.7701-2(c)(2)(iii). Enter the owner's
            name on line 1. The name of the entity entered on line 1 should
            never be a disregarded entity. The name on line 1 should be the name
            shown on the income tax return on which the income should be
            reported. For example, if a foreign LLC that is treated as a
            disregarded entity for U.S. federal tax purposes has a single owner
            that is a U.S. person, the U.S. owner's name is required to be
            provided on line 1. If the direct owner of the entity is also a
            ...
            line 2, “Business name/disregarded entity name.” If the owner of the
            disregarded entity is a foreign person, the owner must complete an
            appropriate Form W-8 instead of a Form W-9. This is the case even if
            the foreign person has a U.S. TIN. <br />
          ...
          <p className="first-table-fw9">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      ...
                      limited liability company (LLC) owned by an individual and
                  ...
                  <tr>
                    <td>
                      ...
                      taxed as a corporation, or • LLC that is disregarded as an
                      entity separate from its owner but the owner is another
            ...
            <span className="fw9-span-right">
              <p style={{ fontWeight: "500" }}>
                ...
                transactions. <br /> • Corporations are not exempt from backup
                withholding with respect to attorneys’ fees or gross proceeds
                paid to attorneys, and corporations that provide medical or
                health care services are not exempt with respect to payments
                reportable on Form 1099-MISC. The following codes identify
                payees that are exempt from backup withholding. Enter the
                appropriate code in the space in line 4. <br /> 1—An
                organization exempt from tax under section 501(a), any IRA, or a
                custodial account under section 403(b)(7) if the account
                satisfies the requirements of section 401(f)(2) <br /> 2—The
                United States or any of its agencies or instrumentalities <br />{" "}
                3—A state, the District of Columbia, a U.S. commonwealth or
                possession, or any of their political subdivisions or
                instrumentalities <br /> 4—A foreign government or any of its
                political subdivisions, agencies, or instrumentalities <br />{" "}
                5—A corporation <br /> 6—A dealer in securities or commodities
                required to register in the United States, the District of
                Columbia, or a U.S. commonwealth or possession <br /> 7—A
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            backup withholding. The chart applies to the exempt payees listed
            above, 1 through 13.
          </p>
          <p className="first-table-fw9">
            <span className="fw9-span-left" style={{ fontWeight: "500" }}>
            ...
            <span className="fw9-span-right">
              <p style={{ fontWeight: "500" }}>
                ...
                instructions. <br /> 2 However, the following payments made to a
                ...
                <br /> A—An organization exempt from tax under section 501(a) or
                any individual retirement plan as defined in section 7701(a)(37){" "}
                <br />
                B—The United States or any of its agencies or instrumentalities
                <br /> C—A state, the District of Columbia, a U.S. commonwealth
                or possession, or any of their political subdivisions or
                instrumentalities <br /> D—A corporation the stock of which is
                regularly traded on one or more established securities markets,
                as described in Regulations section 1.1472-1(c)(1)(i)
              </p>
            </span>
          </p>
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            <br /> H—A regulated investment company as defined in section 851 or
            ...
            wish to consult with the financial institution requesting this form
            to determine whether the FATCA code and/or exempt payee code should
            be completed. <br />
            <span style={{ fontWeight: "bold" }}>
              Line 5 <br />
            </span>
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            your IRS individual taxpayer identification number (ITIN). Enter it
            in the social security number box. If you do not have an ITIN, see
            How to get a TIN below. <br /> If you are a sole proprietor and you
            have an EIN, you may enter either your SSN or EIN. If you are a
            single-member LLC that is disregarded as an entity separate from its
            owner, enter the owner’s SSN (or EIN, if the owner has one). Do not
            enter the disregarded entity’s EIN.
            <br /> If the LLC is classified as a corporation or partnership,
            enter the entity’s EIN.{" "}
            <span style={{ fontWeight: "bold" }}>Note:</span> See What Name and
            Number To Give the Requester, later, for further clarification of
            ...
            apply for a TIN and write “Applied For” in the space for the TIN,
            sign and date the form, and give it to the requester. For interest
            ...
            the person identified on line 1 must sign. Exempt payees, see Exempt
            payee code, earlier. Signature requirements. Complete the
            certification as indicated in items 1 through 5 below.
          </p>
          <p style={{ fontWeight: "500" }}>
            <span style={{ fontWeight: "bold" }}>
              1. Interest, dividend, and barter exchange accounts opened before
              1984 and broker accounts considered active during 1983. <br />
            </span>{" "}
            You must give your correct TIN, but you do not have to sign the
            certification.{" "}
            <span style={{ fontWeight: "bold" }}>
              certification. 2. Interest, dividend, broker, and barter exchange
              accounts opened after 1983 certification. <br />{" "}
            </span>{" "}
            ...
            certification before signing the form. certification before signing
            the form.
            <br />
            <span style={{ fontWeight: "bold" }}>
            ...
            <span style={{ fontWeight: "bold" }}>4. Other payments.</span>{" "}
            <br /> form. You may cross out item 2 of the certification. You must
            ...
            incorrect TIN. “Other payments” include payments made in the course
            of the requester’s trade or business for rents, royalties, goods
            ...
            services, payments made in settlement of payment card and third
            party network transactions, payments to certain fishing boat crew
          ...
          <p className="first-table-fw9">
                ...
                <tbody>
                  <tr>
                    <td>
                      ...
                      account) other than an account maintained by an FFI <br />{" "}
                      3. Two or more U.S. persons (joint account maintained by
                      an FFI) <br /> 4. Custodial account of a minor (Uniform
                      Gift to Minors Act) <br /> 5. a. The usual revocable
                      savings trust (grantor is also trustee) b. So-called trust
                      account that is not a legal or valid trust under state law
                      <br /> 6. Sole proprietorship or disregarded entity owned
                      by an individual <br /> 7. Grantor trust filing under
                      Optional Form 1099 Filing Method 1 (see Regulations
                      section 1.671-4(b)(2)(i) (A))
                    </td>
                    <td>
                      The individual <br /> The actual owner of the account{" "}
                      <br /> or, if combined funds, the first individual on the
                      account1 <br /> Each holder of the account <br /> The
                      minor <br /> <br /> The grantor-trustee <br /> The actual
                      owner The owner The grantor*
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>
                      8. Disregarded entity not owned by an individual <br /> 9.
                      A valid trust, estate, or pension trust
                      <br /> 10. Corporation or LLC electing corporate status on
                    ...
                    <td>
                      The owner <br /> Legal entity4 The corporation <br /> The
                      organization <br /> The partnership <br /> The broker or
                      nominee
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style={{ fontWeight: "bold" }}>
                      ...
                      program payments <br /> 15. Grantor trust filing under the
                      Form 1041 Filing Method or the Optional Form 1099 Filing
                      Method 2 (see Regulations section 1.671-4(b)(2)(i)(B))
                    </td>
                    <td style={{ fontWeight: "bold" }}>
            ...
            <span className="fw9-span-right">
              <p style={{ fontWeight: "500" }}>
                ...
                person’s number must be furnished. <br /> 2 Circle the minor’s
                name and furnish the minor’s SSN.
                ...
                SSN.
                <br /> 4 List first and circle the name of the trust, estate, or
                ...
                <span style={{ fontWeight: "bold" }}>Note:</span> If no name is
                circled when more than one name is listed, the number will be
                considered to be that of the first name listed. considered to be
                ...
                name, SSN, or other identifying information, without your
                ...
                help in resolving tax problems that have not been resolved
                through normal channels, may be eligible for Taxpayer Advocate
                Service (TAS) assistance. You can reach TAS by calling the TAS
                ...
                identity theft. <br /> The IRS does not initiate contacts with
                ...
                their credit card, bank, or other financial accounts. <br /> If
                ...
                Pub. 5027. <br /> Visit www.irs.gov/IdentityTheft to learn more
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            and U.S. commonwealths and possessions for use in administering
            their laws. The information also may be disclosed to other countries
            ...
            payers must generally withhold a percentage of taxable interest,
            dividend, and certain other payments to a payee who does not give a
            TIN to the payer. Certain penalties may also apply for providing
