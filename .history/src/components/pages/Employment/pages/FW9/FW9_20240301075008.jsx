...
export const FW9 = () => {
  ...
  const content = {
    ...
    secondItem: [
      ...
      {
        para: "The Foreign Account Tax Compliance Act (FATCA) requires a
      ...
      {
        para: "You must provide updated information to any person to whom you
      ...
      {
        para: "Failure to furnish TIN. If you fail to furnish your correct TIN to a
