...
export const FW9 = () => {
  ...
  const content = {
    ...
    secondItem: [
      {
        para: "• Form 1099-DIV (dividends, including those from stocks or mutual funds) • Form 1099-MISC (various types of income, prizes, awards, or grossbnproceeds)bn• Form 1099-B (stock or mutual fund sales and certain otherbntransactions by brokers)bn• Form 1099-S (proceeds from real estate transactions)bn• Form 1099-K (merchant card and third party network transactions)bn• Form 1098 (home mortgage interest), 1098-E (student loan interest),bn1098-T (tuition)bn• Form 1099-C (canceled debt)bn• Form 1099-A (acquisition or abandonment of secured property)bnUse Form W-9 only if you are a U.S. person (including a residentbnalien), to provide your correct TIN.bnIf you do not return Form W-9 to the requester with a TIN, you mightbnbe subject to backup withholding. See What is backup withholding,bnlater.",
        status: "heading",
      },
      {
        para: "Section references are to the Internal Revenue Code unless otherwise oted",
