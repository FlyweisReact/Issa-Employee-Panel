...
export const FW9 = () => {
  ...
  const content = {
    ...
    secondItem: [
        ...
        parent: {
          ...
          body: [
            ...
            },
            {
              ...
              second: "Individual/sole proprietor or singlemember LLC",
            },
            {
              first:
                "• LLC treated as a partnership for U.S. federal tax purposes, • LLC that has filed Form 8832 or 2553 to be taxed as a corporation, or • LLC that is disregarded as an entity separate from its owner but the owner is another LLC that is  not disregard  for U.S. federal tax purposes.",
              second:
      ...
      {
        para: "Line 4, Exemptions",
        status: "heading",
      },
      {
        para: "If you are exempt from backup withholding and/or FATCA reporting, enter in the appropriate space on line 4 any code(s) that may apply to you. Exempt payee code. • Generally, individuals (including sole proprietors) are not exempt from backup withholding. • Except as provided below, corporations are exempt from backup withholding for certain payments, including interest and dividends. • Corporations are not exempt from backup withholding for payments made in settlement of payment card or third party network transactions. • Corporations are not exempt from backup withholding with respect to attorneys’ fees or gross proceeds paid to attorneys, and corporations  that provide medical or health care services are not exempt with respect  to payments reportable on Form 1099-MISC. The following codes identify payees that are exempt from backup  withholding. Enter the appropriate code in the space in line 4.  1—An organization exempt from tax under section 501(a), any IRA, or  a custodial account under section 403(b)(7) if the account satisfies the  requirements of section 401(f)(2)  2—The United States or any of its agencies or 3—A state, the District of Columbia, a U.S. commonwealth or  possession, or any of their political subdivisions or instrumentalities  4—A foreign government or any of its political subdivisions, agencies,   or instrumentalities 5—A corporation 6—A dealer in securities or commodities required to register in the    United States, the District of Columbia, or a U.S. commonwealth or possession 7—A futures commission merchant registered with the Commodity Futures Trading Commission 8—A real estate investment trust 9—An entity registered at all times during the tax year under the Investment Company Act of 1940 10—A common trust fund operated by a bank under section 584(a) 11—A financial institution 12—A middleman known in the investment community as a nominee or custodian 13—A trust exempt from tax under section 664 or described in section    4947",
        status: "desc",
      },
      {
        para: "M—A tax exempt trust under a section 403(b) plan or section 457(g) plan Note: You may wish to consult with the financial institution requesting this form to determine whether the FATCA code and/or exempt payee code should be completed",
        status: "desc",
      },
      {
        para: "Line 5",
      ...
      {
        para: "Enter your city, state, and ZIP code.",
        status: "desc",
      },
      {
        para: "Part I. Taxpayer Identification Number (TIN)",
        status: "heading",
      },
      {
        para: "Enter your TIN in the appropriate box. If you are a resident alien and  you do not have and are not eligible to get an SSN, your TIN is your IRS individual taxpayer identification number (ITIN). Enter it in the social  security number box. If you do not have an ITIN, see How to get a TIN below",
        status: "desc",
      },
      {
        para: "If you are a sole proprietor and you have an EIN, you may enter either your SSN or EIN. ",
        status: "desc",
      },
      {
        para: "If you are a single-member LLC that is disregarded as an entity separate from its owner, enter the owner’s SSN (or EIN, if the owner has one). Do not enter the disregarded entity’s EIN. If the LLC is classified as a corporation or partnership, enter the entity’s EIN.",
        status: "desc",
      },
      {
        para: "Note: See What Name and Number To Give the Requester, later, for further clarification of name and TIN combinations.",
        status: "desc",
      },
      {
        para: "How to get a TIN. If you do not have a TIN, apply for one immediately. To apply for an SSN, get Form SS-5, Application for a Social Security Card, from your local SSA office or get this form online at  www.SSA.gov. You may also get this form by calling 1-800-772-1213. Use Form W-7, Application for IRS Individual Taxpayer Identification Number, to apply for an ITIN, or Form SS-4, Application for Employer Identification Number, to apply for an EIN. You can apply for an EIN online by accessing the IRS website at www.irs.gov/Businesses and clicking on Employer Identification Number (EIN) under Starting a Business. Go to www.irs.gov/Forms to view, download, or print Form W-7 and/or Form SS-4. Or, you can go to www.irs.gov/OrderForms to place an order and have Form W-7 and/or SS-4 mailed to you within 10 business days",
        status: "desc",
      },
      {
        para: "If you are asked to complete Form W-9 but do not have a TIN, apply for a TIN and write “Applied For” in the space for the TIN, sign and date the form, and give it to the requester. For interest and dividend payments, and certain payments made with respect to readily tradable instruments, generally you will have 60 days to get a TIN and give it to the requester before you are subject to backup withholding on payments. The 60-day rule does not apply to other types of payments. You will be subject to backup withholding on all such payments until  you provide your TIN to the requester",
        status: "desc",
      },
      {
        para: "Note: Entering “Applied For” means that you have already applied for a TIN or that you intend to apply for one soon",
        status: "desc",
      },
      {
        para: "Caution: A disregarded U.S. entity that has a foreign owner must use the appropriate Form W-8.",
        status: "desc",
      },
      {
        para: "Part II. Certification",
        status: "heading",
      },
      {
        para: "To establish to the withholding agent that you are a U.S. person, or  resident alien, sign Form W-9. You may be requested to sign by the  withholding agent even if item 1, 4, or 5 below indicates otherwise.",
        status: "desc",
      },
      {
        para: "For a joint account, only the person whose TIN is shown in Part I should sign (when required). In the case of a disregarded entity, the person identified on line 1 must sign. Exempt payees, see Exempt payee code, earlier.",
        status: "desc",
      },
      {
        para: "Signature requirements. Complete the certification as indicated in  items 1 through 5 below.",
        status: "desc",
      },
      {
        status: "table",
      ...
      {
        para: "1   List first and circle the name of the person whose number you furnish. If only one person on a joint account has an SSN, that person’s number must be furnished",
        status: "desc",
      },
      {
      ...
      <Container className="full-width-container">
        <form className="w-100 text-start" onSubmit={submitHandler}>
          <p className="fw-bold text-center">
            ▶ Go to <a href='www.irs.gov/FormW9' target='_blank' rel="">www.irs.gov/FormW9</a> for instructions and the latest
            information.
          </p>
          <div className="grid-container">
            ...
            <div className="grid-item full-wid-input">
              ...
              <CheckBoxMaker
                ...
                value={"S"}
                label={"S"}
                checked={llcTaxClassification === "S"}
              ...
              <CheckBoxMaker
                ...
                value={"P"}
                label={"P"}
                checked={llcTaxClassification === "P"}
