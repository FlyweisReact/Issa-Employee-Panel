...
export const FW9 = () => {
  ...
  const payload = {
    name , 
    businessName  , taxClassification  , llcTaxClassification , other  , exemptionsPayeeCode , exemptionsFatCaExemptionCode , street , city  , state
    , zipCode
     , requesterName ,  requesterAddress , accountNumbers , tinSsn , tinEin
  }; 
