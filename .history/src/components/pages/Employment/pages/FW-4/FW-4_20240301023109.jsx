...
export const FW4Form = () => {
  ...
  const payload = {
    step1FirstName ,  step1LastName , step1Address , step1City , step1State  , step1ZipCode , step1SocialSecurityNumber , step1IsNameMatched , step1FilingStatus , step2Choose , step2Ca , step2Cb , step3QualifyingChildrenCredit , step3OtherDependentsCredit , step3TotalCredits , step4OtherIncome , step4Deductions  , step4ExtraWithholding , step5EmployeeSignature , step5Date , employerName , employerAddress , firstDateOfEmployment , employerEIN , step2bLine1 , step2bLine2a , step2bLine2b  , step2bLine2c , step2bLine3 , step2bLine4 , step4bLine1
  };
