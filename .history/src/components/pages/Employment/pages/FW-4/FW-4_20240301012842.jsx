        ...
        <form className="w-100 text-start">
          ...
          <div className="grid-container">
            ...
            <div className="grid-item third-wid-input">
              <label>
                <span>
                  (b) Deductions. If you expect to claim deductions other than
                  the standard deduction and want to reduce your withholding,
                  use the Deductions Worksheet on page 3 and enter the result
                  here{" "}
                  <span>
                    <BorderlessInput
