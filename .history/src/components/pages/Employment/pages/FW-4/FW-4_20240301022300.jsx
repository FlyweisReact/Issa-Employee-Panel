    ...
    <>
      ...
      <Container className="full-width-container">
        <form className="w-100 text-start">
          ...
          <Image src="/Employment/FW4/image 102.png" className="mb-3" fluid />
          <Image src="/Employment/FW4/image 103.png" className="mb-3" fluid />
          <Image src="/Employment/FW4/image 104.png" className="mb-3" fluid />
        </form>
      </Container>
    </>
  );
