...
export const FW4Form = () => {
  ...
  return (
  <>
  <NavWrapper title={"Employee’s Withholding Certificate"} isArrow  />
      ...
      <div className="nav-wrap-personal">
        ...
        <div className="nav-div-personal">
          <p style={{ fontSize: ".9rem", fontWeight: "bold" }}>
            EMPLOYEE’S WITH HOLDING CERTIFICATE
          </p>
        </div>
      </div>
      <div className="top-div-personal">
        ...
        >
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            to ensure you get credit for your earnings, contact SSA at
          ...
          <p>
            ...
            those steps blank for the other jobs.{" "}
            <span style={{ fontWeight: "500" }}>
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            You may add to this the amount of any other credits. Enter the total
            here
          </p>
          <Form.Group className="mb-3">
            {/* <Form.Label
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              here. This may include interest, dividends, and retirement income
              . . . . . . . .
            </span>
            <br />
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              deduction and want to reduce your withholding, use the Deductions
              Worksheet on page 3 and enter the result here . . . . . . . .
            </span>
            <br />
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            see Pub. 505, Tax Withholding and Estimated Tax. Exemption from
            withholding. You may claim exemption from withholding for 2023 if
            you meet both of the following conditions: you had no federal income
            tax liability in 2022 and you expect to have no federal income tax
            liability in 2023. You had no federal income tax liability in 2022
            if (1) your total tax on line 24 on your 2022 Form 1040 or 1040-SR
            ...
            and may owe taxes and penalties when you file your 2023 tax return.
            ...
            February 15, 2024. Your privacy. If you have concerns with Step
            2(c), you may choose Step 2(b); if you have concerns with Step 4(a),
            you may enter an additional amount you want withheld per pay period
            in Step 4(c). Self-employment. Generally, you will owe both income
            and self-employment taxes on any self-employment income you receive
            separate from the wages you receive as an employee. If you want to
            pay income and self-employment taxes through withholding from your
            wages, you should enter the self-employment income on Step 4(a).
            Then compute your self-employment tax, divide that tax by the number
            of pay periods remaining in the year, and include that resulting
            amount per pay period on Step 4(c). You can also add half of the
            annual amount of self-employment tax to Step 4(b) as a deduction. To
            calculate self-employment tax, you generally multiply the
            self-employment income by 14.13% (this rate is a quick way to figure
            your self employment tax and equals the sum of the 12.4% social
            security tax and the 2.9% Medicare tax multiplied by 0.9235). See
            Pub. 505 for more information, especially if the sum of
            self-employment income multiplied by 0.9235 and wages exceeds
            $160,200 for a given individual. Nonresident alien. If you’re a
            nonresident alien, see Notice 1392, Supplemental Form W-4
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              work. If you (and your spouse) have a total of only two jobs, you
              may check the box in option (c). The box must also be checked on
              the Form W-4 for the other job. If the box is checked, the
              ...
              difference in pay is between the two jobs. CAUTION Multiple jobs.
              Complete Steps 3 through 4(b) on only one Form W-4. Withholding
              will be most accurate if you do this on the Form W-4 for the
              highest paying job.
            </span>{" "}
            <br />
            Step 3.{" "}
            <span style={{ fontWeight: "500" }}>
              {" "}
              This step provides instructions for determining the amount of the
              child tax credit and the credit for other dependents that you may
              be able to claim when you file your tax return. To qualify for the
              child tax credit, the child must be under age 17 as of December
              31, must be your dependent who generally lives with you for more
              than half the year, and must have the required social security
              number. You may be able to claim a credit for other dependents for
              whom a child tax credit can’t be claimed, such as an older child
              or a qualifying relative. For additional eligibility requirements
              for these credits, see Pub. 501, Dependents, Standard Deduction,
              and Filing Information. You can also include other tax credits for
              which you are eligible in this step, such as the foreign tax
              credit and the education tax credits. To do so, add an estimate of
              the amount for the year to your credits for dependents and enter
              the total amount in Step 3. Including these credits will increase
              your paycheck and reduce the amount of any refund you may receive
              when you file your tax return. Step 4 (optional).
            </span>{" "}
            <br />
            Step 4(a).{" "}
            <span style={{ fontWeight: "500" }}>
              ...
              self-employment. If you complete Step 4(a), you likely won’t have
              to make estimated tax payments for that income. If you prefer to
              pay estimated tax rather than having tax on other income withheld
              from your paycheck, see Form 1040-ES, Estimated Tax for
              Individuals.
            </span>{" "}
            <br />
            Step 4(b).{" "}
            <span style={{ fontWeight: "500" }}>
              {" "}
              Enter in this step the amount from the Deductions Worksheet, line
              5, if you expect to claim deductions other than the basic standard
              deduction on your 2023 tax return and want to reduce your
              withholding to account for these deductions. This includes both
              itemized deductions and other deductions such as for student loan
              interest and IRAs.
            </span>{" "}
            <br />
            ...
            Multiple Jobs Worksheet, line 4. Entering an amount here will reduce
            your paycheck and will either increase your refund or reduce any
          ...
          <p style={{ fontWeight: "500" }}>
            ...
            only ONE Form W-4. Withholding will be most accurate if you complete
            the worksheet and enter the result on the Form W-4 for the highest
            paying job. To be accurate, submit a new Form W-4 for all other jobs
            if you have not updated your withholding since 2019.
          </p>
          <p>
            Note:{" "}
            <span style={{ fontWeight: "500" }}>
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              {" "}
              If you have two jobs or you’re married filing jointly and you and
              your spouse each have one job, find the amount from the
              appropriate table on page 4. Using the “Higher Paying Job” row and
              the “Lower Paying Job” column, find the value at the intersection
              of the two household salaries and enter that value on line 1.
              Then, skip to line 3 . . . . . . . . . . . . . . . .
            </span>
          </p>
          <Form.Group className="mb-3">
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              Job” row and the annual wages for your next highest paying job in
              the “Lower Paying Job” column. Find the value at the intersection
              of the two household salaries and enter that value on line 2a . .
              . . . . . . . . . . .{" "}
            </span>
          </p>
          <Form.Group className="mb-3">
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              together and use the total as the wages in the “Higher Paying Job”
              row and use the annual wages for your third job in the “Lower
              Paying Job” column to find the amount from the appropriate table
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              {" "}
              Add the amounts from lines 2a and 2b and enter the result on line
              2c . . .
            </span>
          </p>
          <Form.Group className="mb-3">
          ...
          <p>
            4.
            <span style={{ fontWeight: "500" }}>
              Divide the annual amount on line 1 or line 2c by the number of pay
              periods on line 3. Enter this amount here and in Step 4(c) of Form
              W-4 for the highest paying job (along with any other additional
          ...
          <p>
            ...
            <br />
            <span style={{ fontWeight: "500" }}>(Keep for your records.)</span>
          </p>
          <p>
            1.
            <span style={{ fontWeight: "500" }}>
              Enter an estimate of your 2023 itemized deductions (from Schedule
              A (Form 1040)). Such deductions may include qualifying home
              mortgage interest, charitable contributions, state and local taxes
              (up to $10,000), and medical expenses in excess of 7.5% of your
              income . . .
            </span>
          </p>
          <Form.Group className="mb-3">
          ...
          <p>
            2.
            <span style={{ fontWeight: "500" }}>
              Enter: • $27,700 if you’re married filing jointly or a qualifying
              surviving spouse • $20,800 if you’re head of household • $13,850
              if you’re single or married filing separately . . . .
            </span>
          </p>
          <Form.Group className="mb-3">
          ...
          <p>
            3.
            <span style={{ fontWeight: "500" }}>
              If line 1 is greater than line 2, subtract line 2 from line 1 and
              enter the result here. If line 2 is greater than line 1, enter
              “-0-” . . . .
            </span>
          </p>
          <Form.Group className="mb-3">
...
adjustments (from Part II of Schedule 1 (Form 1040)). See Pub. 505 for more information  . . . .
          ...
          <p>
            5.
            <span style={{ fontWeight: "500" }}>
              Add lines 3 and 4. Enter the result here and in Step 4(b) of Form
              W-4 . .
            </span>
          </p>
          <Form.Group className="mb-3">
          ...
          <p>
            ...
            <span style={{ fontWeight: "500" }}>
              ...
              income tax withholding. Failure to provide a properly completed
              form will result in your being treated as a single person with no
              other entries on the form; providing fraudulent information may
              ...
              laws; and to the Department of Health and Human Services for use
              in the National Directory of New Hires. We may also disclose this
          ...
          <div className="image-div-fw-4" >
            <img
              src="/Employment/FW4/image 102.png"
             
              alt="w4"
            />
            <img
              src="/Employment/FW4/image 103.png"
              alt="w4"
            />
            <img
              src="/Employment/FW4/image 104.png"
              alt="w4"
            />
          </div>
