      ...
      <Container className="full-width-container">
        <form className="w-100 text-start">
          ...
          <div className="grid-container">
            ...
            <div className="grid-item full-wid-input ">
              <label>
                If you choose the option in Step 2(b) on Form W-4, complete this  worksheet (which calculates the total extra tax for all jobs) on   only ONE Form W-4. Withholding will be most accurate if you   complete the worksheet and enter the result on the Form W-4 for
