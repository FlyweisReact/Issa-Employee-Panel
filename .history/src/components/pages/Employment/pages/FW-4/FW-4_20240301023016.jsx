...
export const FW4Form = () => {
  ...
  const payload = {
    step1FirstName ,  step1LastName , step1Address , step1City , step1State  , step1ZipCode , step1SocialSecurityNumber , step1IsNameMatched , step1FilingStatus , step2Choose , step2Ca , step2Cb , step3QualifyingChildrenCredit , step3OtherDependentsCredit , step3TotalCredits , step4OtherIncome , step4Deductions  , step4ExtraWithholding
  };
