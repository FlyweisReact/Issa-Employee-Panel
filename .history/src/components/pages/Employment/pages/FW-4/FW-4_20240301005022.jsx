...
export const FW4Form = () => {
  ...
  const [step2bLine2a, setStep2bLine2a] = useState("reqbodystep2bLine2a");
  const [step2bLine2b, setStep2bLine2b] = useState("reqbodystep2bLine2b");
  const [step2bLine2c, setStep2bLine2c] = useState("reqbodystep2bLine2c");
  const [step2bLine3, setStep2bLine3] = useState("reqbodystep2bLine3");
  const [step2bLine4, setStep2bLine4] = useState("reqbodystep2bLine4");
  const [step4bLine1, setStep4bLine1] = useState("reqbodystep4bLine1");
  const [step4bLine2, setStep4bLine2] = useState("reqbodytep4bLine2");
