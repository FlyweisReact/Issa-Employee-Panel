...
export const FW4Form = () => {
  ...
  const [step1FirstName, setStep1FirstName] = useState("req.body.step1FirstName");
  const [step1LastName, setStep1LastName] = useState("req.body.step1LastName");
  const [step1Address, setStep1Address] = useState("req.body.step1Address");
  const [step1City, setStep1City] = useState("req.body.step1City");
  const [step1State, setStep1State] = useState("req.body.step1State");
  const [step1ZipCode, setStep1ZipCode] = useState("req.body.step1ZipCode");
  const [step1SocialSecurityNumber, setStep1SocialSecurityNumber] = useState("req.body.step1SocialSecurityNumber");
  const [step1IsNameMatched, setStep1IsNameMatched] = useState("req.body.step1IsNameMatched");
  const [step1FilingStatus, setStep1FilingStatus] = useState("req.body.step1FilingStatus");
  const [step2Choose, setStep2Choose] = useState("req.body.step2Choose");
  const [step2Ca, setStep2Ca] = useState("req.body.step2Ca");
  const [step2Cb, setStep2Cb] = useState("req.body.step2Cb");
  const [step3QualifyingChildrenCredit, setStep3QualifyingChildrenCredit] = useState("req.body.step3QualifyingChildrenCredit");
  const [step3OtherDependentsCredit, setStep3OtherDependentsCredit] = useState("req.body.step3OtherDependentsCredit");
  const [step3TotalCredits, setStep3TotalCredits] = useState("req.body.step3TotalCredits");
  const [step4OtherIncome, setStep4OtherIncome] = useState("req.body.step4OtherIncome");
  const [step4Deductions, setStep4Deductions] = useState("req.body.step4Deductions");
  const [step4ExtraWithholding, setStep4ExtraWithholding] = useState("req.body.step4ExtraWithholding");
  const [step5EmployeeSignature, setStep5EmployeeSignature] = useState("req.body.step5EmployeeSignature");
  const [step5Date, setStep5Date] = useState("req.body.step5Date");
  const [employerName, setEmployerName] = useState("req.body.employerName");
  const [employerAddress, setEmployerAddress] = useState("req.body.employerAddress");
  const [firstDateOfEmployment, setFirstDateOfEmployment] = useState("req.body.firstDateOfEmployment");
  const [employerEIN, setEmployerEIN] = useState("req.body.employerEIN");
  const [step2bLine1, setStep2bLine1] = useState("req.body.step2bLine1");
  const [step2bLine2a, setStep2bLine2a] = useState("req.body.step2bLine2a");
  const [step2bLine2b, setStep2bLine2b] = useState("req.body.step2bLine2b");
  const [step2bLine2c, setStep2bLine2c] = useState("req.body.step2bLine2c");
  const [step2bLine3, setStep2bLine3] = useState("req.body.step2bLine3");
  const [step2bLine4, setStep2bLine4] = useState("req.body.step2bLine4");
  const [step4bLine1, setStep4bLine1] = useState("req.body.step4bLine1");
  const [step4bLine2, setStep4bLine2] = useState("req.body.step4bLine2");
  const [step4bLine3, setStep4bLine3] = useState("req.body.step4bLine3");
  const [step4bLine4, setStep4bLine4] = useState("req.body.step4bLine4");
  const [step4bLine5, setStep4bLine5] = useState("req.body.step4bLine5");
  return (
    <>
