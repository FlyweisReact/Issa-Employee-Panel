...
export const FW4Form = () => {
  ...
  const content = {
    firstItem: [
      ...
      {
        para: "If you have concerns with Step 2(c), you may  choose Step 2(b); if you have concerns with Step 4(a), you may enter an additional amount you want withheld per pay
        period in Step 4(c)",
        status: "heading",
      },
    ],
