...
export const FW4Form = () => {
  ...
  const [step4bLine2, setStep4bLine2] = useState("reqbody.tep4bLine2");
  const [step4bLine3, setStep4bLine3] = useState("reqbodystep4bLine3");
  const [step4bLine4, setStep4bLine4] = useState("reqbodystep4bLine4");
  const [step4bLine5, setStep4bLine5] = useState("reqbodystep4bLine5");
  return (
    <>
