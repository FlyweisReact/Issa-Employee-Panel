...
export const FW4Form = () => {
  ...
  const content = {
    ...
    secondItem: [
      ...
      {
        para: "Step 3. This step provides instructions for determining the amount of the child tax credit and the credit for other dependents that you may be able to claim when you file your
