    ...
    <>
      ...
      <Container className="full-width-container">
        <form className="w-100 text-start">
          ...
          <div className="instruction-content" style={{ padding: 0 }}>
            <div className="deivider" style={{ padding: 0 }}>
              <div className="items" style={{ padding: 0 }}>
