...
export const FW4Form = () => {
  ...
  const [step2bLine3, setStep2bLine3] = useState("reqbody.step2bLine3");
  const [step2bLine4, setStep2bLine4] = useState("reqbody.step2bLine4");
  const [step4bLine1, setStep4bLine1] = useState("reqbody.step4bLine1");
  const [step4bLine2, setStep4bLine2] = useState("reqbody.step4bLine2");
  const [step4bLine3, setStep4bLine3] = useState("reqbody.step4bLine3");
  const [step4bLine4, setStep4bLine4] = useState("reqbody.step4bLine4");
  const [step4bLine5, setStep4bLine5] = useState("reqbody.step4bLine5");
  return (
    <>
