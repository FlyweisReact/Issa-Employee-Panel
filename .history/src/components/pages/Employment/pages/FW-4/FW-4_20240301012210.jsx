      ...
      <Container className="full-width-container">
        <form className="w-100 text-start">
          ...
          <div className="grid-container">
            ...
            <div className="grid-item long-input"></div>
            <div className="grid-item long-input">
              <label>Add the amounts above for qualifying children and other dependents. You may add to
this the amount of any other credits. Enter the total here</label>
              <BorderlessInput
                setState={setStep3OtherDependentsCredit}
                placeholder={""}
                type={"number"}
