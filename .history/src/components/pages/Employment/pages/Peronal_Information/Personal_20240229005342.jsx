...
export const Personal = () => {
  ...
  const [middleInitial, setMiddleInitial] = useState("M");
  const [addressStreet, setAddressStreet] = useState("123 Main St");
  const [addressCity, setAddressCity] = useState("City Name");
  const [addressState, setAddressState] = useState("State");
  const [addressZip, setAddressZip] = useState("12345");
  const [socSecNo, setSocSecNo] = useState("123-45-6789");
  const [birthDate, setBirthDate] = useState("1990-01-01T00:00:00.000Z");
  const [telephoneHome, setTelephoneHome] = useState("123-456-7890");
  const [telephonePersonalCell, setTelephonePersonalCell] = useState("987-654-3210");
  const [telephoneWork, setTelephoneWork] = useState("555-555-5555");
  const [telephoneBusinessCell, setTelephoneBusinessCell] = useState("444-444-4444");
  const [dLStateOfIssue, setDLStateOfIssue] = useState("State");
  const [dLNumber, setDLNumber] = useState("DL123456");
  const [dLExpirationDate, setDLExpirationDate] = useState("2023-12-31T00:00:00.000Z");
  const [businessEmail, setBusinessEmail] = useState("business@example.com");
  const [personalEmail, setPersonalEmail] = useState("personal@example.com");
  const [emergencyContactName, setEmergencyContactName] = useState("Emergency Contact");
  const [emergencyContactRelationship, setEmergencyContactRelationship] = useState("Relative");
  const [emergencyContactNumber, setEmergencyContactNumber] = useState("555-123-4567");
