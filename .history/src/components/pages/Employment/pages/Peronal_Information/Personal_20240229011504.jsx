...
export const Personal = () => {
  ...
  const payload = {
    ...
    telephoneBusinessCell , dLStateOfIssue  , dLNumber , dLExpirationDate , businessEmail , personalEmail , emergencyContactName , emergencyContactRelationship  , emergencyContactNumber
  };
