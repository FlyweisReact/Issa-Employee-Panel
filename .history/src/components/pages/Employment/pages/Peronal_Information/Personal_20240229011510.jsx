...
export const Personal = () => {
  ...
  const payload = {
    ...
    firstName ,
    middleInitial,
    addressStreet ,  addressCity , addressState , addressZip ,socSecNo , birthDate , telephoneHome , telephonePersonalCell , telephoneWork , 
    telephoneBusinessCell , dLStateOfIssue  , dLNumber , dLExpirationDate , businessEmail , personalEmail , emergencyContactName , emergencyContactRelationship  , emergencyContactNumber , savedSigned
  };
