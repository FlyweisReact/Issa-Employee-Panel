...
export const Personal = () => {
  ...
  const [telephonePersonalCell, setTelephonePersonalCell] =
    useState("987-654-3210");
  const [telephoneWork, setTelephoneWork] = useState("555-555-5555");
  const [telephoneBusinessCell, setTelephoneBusinessCell] =
    useState("444-444-4444");
