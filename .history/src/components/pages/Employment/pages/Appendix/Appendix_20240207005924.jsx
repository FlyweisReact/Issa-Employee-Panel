...
export const Appendix = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      const res=await axios.post(`${Baseurl}employee/createAppendix`,employeeData,Auth());
      console.log(res)
      ...
      <div className="top-div-personal">
        ...
        >
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control required value={employeeData?.date}
              onChange={(e) =>setEmployeeData((prev)=>({...prev,date:e.target.value}))}
              type="date"
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control 
              onChange={(e) => setEmployeeData((prev) => ({ ...prev, positionHiredFor: e.target.value }))}
              type="text"
          ...
          <div key={"radio"} className="mb-3">
            <Form.Check type={"radio"} id={`check-api-${"radio"}`}>
              <Form.Check.Input   
                onClick={(e) => setEmployeeData((prev) => ({ ...prev, spentMoreThan30DaysAbroad: "YES" }))}
          ...
          <div key={"radio"} className="mb-3">
            <Form.Check type={"radio"} id={`check-api-${"radio"}`}>
              <Form.Check.Input   
                onClick={(e) => setEmployeeData((prev) => ({ ...prev, spentMoreThan30DaysAbroad: "NO" }))}
                name="radio2spentMoreThan30DaysAbroad"
                type={"radio"}
                isValid 
              />
          ...
          >
            ...
            <div>
              <Form.Check value={"yes"} type={"radio"} id={`check-api-yes`}>
                <Form.Check.Input   
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, closeContactWithPersonWhoHadActiveTB: "YES" }))}
                  name="radio11"
                  type={"radio"}
                />
              ...
              <Form.Check type={"radio"} id={`check-api-no`}>
                <Form.Check.Input
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, closeContactWithPersonWhoHadActiveTB: "NO" }))}
                  name="radio11"    value={employeeData?.closeContactWithPersonWhoHadActiveTB === "NO"}
                  type={"radio"}
                  isValid
                />
          ...
          <Form.Group className="mb-3">
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              <div style={{ marginBottom: "0", fontWeight: "bold",fontSize: ".9rem", }}>
              ...
              >
                <Form.Check.Input    onChange={(e) =>setEmployeeData({
                  ...employeeData, symptomsFever: "YES"
                })} name="fever" type={"radio"} isValid />
                <Form.Check.Label
              ...
              >
                <Form.Check.Input      onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsFever: "NO" }))} name="fever" type={"radio"} isValid />
          ...
          <Form.Group className="mb-3">
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              >
                <Form.Check.Input   
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsCough: "YES" }))}
                  name="cough"
                  type={"radio"} 
                  isValid
                />
              ...
              >
                <Form.Check.Input   
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsCough: "NO" }))}
                  name="cough"
                  type={"radio"}
                  isValid
                />
          ...
          <Form.Group className="mb-3">
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              >
                <Form.Check.Input   
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsBloodySputum: "YES" }))}
                  name="bloodySputum"
                  type={"radio"}
                  isValid
                />
              ...
              >
                <Form.Check.Input   
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsBloodySputum: "NO" }))}
                  name="bloodySputum"
                  type={"radio"} 
                  isValid
                />
          ...
          <Form.Group className="mb-3">
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              >
                <Form.Check.Input   
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsUnintendedWeightLoss: "YES" }))}
                  name="weightLoss"
                  type={"radio"}
                  isValid
                />
              ...
              >
                <Form.Check.Input   
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsUnintendedWeightLoss: "NO" }))}
                  name="weightLoss"
                  type={"radio"}
                  isValid
                />
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                <Form.Check type={"radio"}  id={`check-api-night-sweats-yes`}>
                  <Form.Check.Input   
                    onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsNightSweats: "YES" }))}
                    name="nightSweats"
                    type={"radio"}
                    isValid
                  />
                ...
                <Form.Check type={"radio"} id={`check-api-night-sweats-no`}>
                  <Form.Check.Input   
                    onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsNightSweats: "NO" }))}
                    name="nightSweats"
                    type={"radio"}
                    isValid
                  />
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                <Form.Check type={"radio"} id={`check-api-fatigue-yes`}>
                  <Form.Check.Input   
                    onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsUnexplainedFatigue: "YES" }))}
                    name="fatigue"
                    type={"radio"}
                    isValid
                  />
                ...
                <Form.Check type={"radio"} id={`check-api-fatigue-no`}>
                  <Form.Check.Input   
                    onChange={(e) => setEmployeeData((prev) => ({ ...prev, symptomsUnexplainedFatigue: "NO" }))}
                    name="fatigue"
                    type={"radio"}
                    isValid
                  />
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                <Form.Check  type={"radio"} id={`check-api-active-tb-yes`}>
                  <Form.Check.Input   
                    onChange={(e) => setEmployeeData((prev) => ({ ...prev, diagnosedWithActiveTB: "YES" }))}
                    name="activeTB1"
                    type={"radio"}
                    isValid
                  />
                ...
                <Form.Check  type={"radio"} id={`check-api-active-tb-no`}>
                  <Form.Check.Input   
                    onChange={(e) => setEmployeeData((prev) => ({ ...prev, diagnosedWithActiveTB: "NO" }))}
                    name="activeTB1"
                    type={"radio"}
                    isValid
                  />
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Check type={"radio"} id={`check-api-${"radio"}`}>
              <Form.Check.Input   
                onChange={(e) => setEmployeeData((prev) => ({ ...prev,     diagnosedWithLatentTB
                : "YES" }))}
          ...
          <Form.Group className="mb-3">
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              >
                <Form.Check.Input   
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, tbTreatmentHistoryMedication: "YES" }))}
              ...
              >
                <Form.Check.Input   
                  name="tbTreatmentHistoryYear1"
                  onChange={(e) => setEmployeeData((prev) => ({ ...prev, tbTreatmentHistoryMedication: "NO" }))}
                  type={"radio"}
                  isValid
                />
                <Form.Check.Label style={{ marginBottom: "0" }}>
          ...
          <Form.Group className="mb-3">
            ...
            name="tbTreatmentHistoryMedication"
              onChange={(e) =>
                setEmployeeData((prev) => ({ ...prev, tbTreatmentHistoryDuration: e.target.value }))
              } 
              required
              type="text"
              placeholder="Enter  text"
          ...
          <Form.Group className="mb-3">
            ...
            name="tbTreatmentHistoryMedication"
              onChange={(e) =>
                setEmployeeData((prev) => ({ ...prev, tbTreatmentHistoryCompletedTreatment: e.target.value }))
              }
              type="text"
              placeholder="Enter  text"
            />
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Check checked={employeeData?.immunization === "YES"} type={"radio"} id={`check-api-${"radio"}`}>
              <Form.Check.Input
                onChange={(e) => setEmployeeData((prev) => ({ ...prev, weakenedImmuneSystem: "YES" }))}
            ...
            <Form.Check checked={employeeData?.immunization === "NO"} type={"radio"} id={`check-api-${"radio"}`}>
              <Form.Check.Input
                onChange={(e) => setEmployeeData((prev) => ({ ...prev, weakenedImmuneSystem: "NO" }))}
                name="weakenedImmuneSystem"
                type={"radio"}
                isValid
                required
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              required
              onChange={(e) =>
                setEmployeeData((prev) => ({ ...prev, reviewerSignature: e.target.value }))
              }
              placeholder="Enter  text"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              onChange={(e) =>setEmployeeData((prev)=>({...prev, reviewDate:e.target.value}))} 
              required
              type="date"
              placeholder="Enter  dATE"
            />
