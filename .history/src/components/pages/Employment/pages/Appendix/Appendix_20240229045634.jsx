...
export const Appendix = () => {
  ...
  const payload = { name, date, preferredContactInformation , positionHiredFor,startDate  , spentMoreThan30DaysAbroad
  ,closeContactWithActiveTB , symptomsFever , symptomsCough , symptomsBloodySputum , symptomsUnintendedWeightLoss , symptomsNightSweats , symptomsUnexplainedFatigue , diagnosedWithActiveTB , diagnosedWithLatentTB , tbTreatmentHistoryYear , tbTreatmentHistoryMedication , tbTreatmentHistoryDuration , tbTreatmentHistoryCompletedTreatment
  , weakenedImmuneSystem , reviewerSignature
  };
