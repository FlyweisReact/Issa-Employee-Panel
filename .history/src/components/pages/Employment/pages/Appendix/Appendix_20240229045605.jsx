...
export const Appendix = () => {
  ...
  ,closeContactWithActiveTB , symptomsFever , symptomsCough , symptomsBloodySputum , symptomsUnintendedWeightLoss , symptomsNightSweats , symptomsUnexplainedFatigue , diagnosedWithActiveTB , diagnosedWithLatentTB , tbTreatmentHistoryYear
