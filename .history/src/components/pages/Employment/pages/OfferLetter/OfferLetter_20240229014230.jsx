      ...
      <Container className="full-width-container">
        <form className="w-100 text-start">
          ...
          <p className="fw-bold">
            ...
            <span>{data?.data?.data?.startingPay} </span> . Your first day of work will be on
            __________________. This offer is conditional upon satisfactory
            completion of your reference checks and obtaining copies of all
            required documentation. The entire team at Company Name is looking
            forward to working with you. We are confident you will be able to
