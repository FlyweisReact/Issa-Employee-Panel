...
export const APS = () => {
  ...
  const [employeeSignature, setEmployeeSignature] = useState("EmployeeSignatureBase64String");
  const [administratorName, setAdministratorName] = useState("Admin Name");
  const [administratorSignature, setAdministratorSignature] = useState("AdminSignatureBase64String");
  const [date, setDate] = useState("2023-12-29T12:00:00Z");
  const [classification, setClassification] = useState("Some Classification");
  const [dateOfIncident, setDateOfIncident] = useState("2023-12-28T12:00:00Z");
        ...
        <form className="w-100 text-start">
          ...
          <div className="grid-container">
            <div className="grid-item full-wid-input">
              <label>
                i. Record Found with (a) Classification (b) Date of the incident
              </label>
