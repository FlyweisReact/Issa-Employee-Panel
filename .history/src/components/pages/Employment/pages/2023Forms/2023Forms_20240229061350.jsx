...
export const Forms2023 = () => {
  ...
  const withholdingOption = if(option === 1) { 
    option === 1 ? 
      option,
      percentage,
      checkBox,
  ...
  const payload = {
    ...
    zipCode,
    withholdingOption: {
      option: option === 1 ? option : null,
      percentage: option === 1 ? percentage : null,
      checkBox: option === 1 ? checkBox : null,
      extraAmount: option === 1 ? extraAmount : null
    },
  };
