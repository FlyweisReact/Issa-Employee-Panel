        ...
        <form className="w-100 text-start">
          ...
          <div>
            ...
            <RadioMaker
              ...
              setValue={setOption}
              id="option1"
              label="1 Withhold from gross taxable wages at the percentage checked (check only one percentage):"
              checked={option}
            />
             <RadioMaker
              name="options"
              ...
              setValue={setOption}
              id="option1"
              label="2. I elect an Arizona withholding percentage of zero, and I certify that I expect to have
