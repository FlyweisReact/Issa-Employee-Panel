...
export const Forms2023 = () => {
  ...
  const content = {
    firstItem: [
      ...
      {
        para: "Complete this form within the first five days of your employment to select an Arizona withholding percentage. You may also  have your employer withhold an extra amount from each  paycheck. If you do not give this form to your employer the
