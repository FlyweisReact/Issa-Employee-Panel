        ...
        <form className="w-100 text-start">
          ...
          <div className="mt-3">
            ...
            <div className="Radio_btns">
              <span className="btns">
                ...
                <RadioMaker
                  name="percentage"
                  setValue={setPercentage}
                  value={"Check this box and enter an extra amount to be withheld from each paycheck"}
                  id={"percentage7"}
                  label={"Check this box and enter an extra amount to be withheld from each paycheck"}
                  checked={percentage}
                />
              </span>
            </div>
            ...
            <RadioMaker
              ...
              setValue={setOption}
              id="option1"
              label="I elect an Arizona withholding percentage of zero, and I certify that I expect to have
