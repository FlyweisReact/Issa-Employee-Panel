...
const Dashboard2 = () => {
  ...
  const [ hireDate , setHireToday ] = useState("")
  ...
  const [ alternativePhoneNumber , setAlternatePhoneNumber] = useState("")
  const [ underAgee18 , setUnderAge18] = useState("")
  const [ ssn , setSsn ] = useState("")
  const [ legallyEligible , setLegallyElig]
