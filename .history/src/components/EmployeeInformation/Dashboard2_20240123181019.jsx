          ...
          >
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="text"
                placeholder=" ________$"
                required   value={fullPartTimeOnly}
