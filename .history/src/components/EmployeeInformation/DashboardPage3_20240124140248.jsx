...
const DashboardPage3 = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      setJobTitle(detail?.previousCompany?.jobTitle);
      setDutiesPerformed(detail?.dutiesPerformed);
      setReasonForLeaving(detail?.reasonForLeaving);
      setMayContactWithEmployee(detail?.mayContactWithEmployee);
