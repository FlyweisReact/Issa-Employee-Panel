...
const DashboardPage3 = () => {
  ...
  const [streetAddress, setStreetAddress] = useState("value_or_variable_for_streetAddress");
  const [city, setCity] = useState("value_or_variable_for_city");
  const [state, setState] = useState("value_or_variable_for_state");
  const [zipCode, setZipCode] = useState("value_or_variable_for_zipCode");
  const [phoneNumber, setPhoneNumber] = useState("value_or_variable_for_phoneNumber");
  const [supervisorNameAndTitle, setSupervisorNameAndTitle] = useState("value_or_variable_for_supervisorNameAndTitle");
