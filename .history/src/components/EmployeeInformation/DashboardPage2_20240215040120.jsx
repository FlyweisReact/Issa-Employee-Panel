  ...
  return (
    <>
      ...
      <Container className="full-width-container">
        ...
        />
        <p style={{ fontWeight: "900", textAlign: "center", fontSize: "14px" }}>
          ...
          surrounding circumstances and relevance of the offense to the position
          for which you are applying will be taken into consideration. False
