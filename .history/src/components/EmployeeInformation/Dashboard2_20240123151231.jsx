        ...
        <div className="top-div-personal2">
          <Form id="form-appendix" className="employee1">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" placeholder="Enter text"  onChange={(e) => setLastName(e.target.value)}/>
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" placeholder="Enter  text"  onChange={(e) => setFirstName(e.target.value)} />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" placeholder="Enter  text"  onChange={(e) => setMiddle(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>
                Maiden:
              </Form.Label>
              <Form.Control type="text" placeholder="Enter  text"  onChange={(e) => setMaiden(e.target.value)} />
            </Form.Group>
            <p>Current Address</p>
            <Form.Group className="mb-3">
              <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text"  onChange={(e) => setHireDate(e.target.value)} />
            </Form.Group>
