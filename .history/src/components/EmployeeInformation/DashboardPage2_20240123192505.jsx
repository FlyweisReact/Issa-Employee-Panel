    ...
    return (
      <Form.Check type={"radio"}>
        <Form.Check.Input
          ...
          id={id}
        />
        <Form.Check.Label htmlFor="radio4"> {label} </Form.Check.Label>
      </Form.Check>
    );
  }
          ...
          >
            ...
            <Form.Group className="mb-3">
              <Form.Label className="Radio_btns">
                ...
                <div className="btns">
                {RadioMaker("highschool" , setLastYearCompleted , 1 ,"highschool1" ,1 )}
                  <Form.Check type={"radio"}>
                    <Form.Check.Input
                      type={"radio"}
                      name="highschool"
                      onChange={() => setLastYearCompleted(1)}
                      isValid
                      id="radio1"
                    />
                    <Form.Check.Label htmlFor="radio1">1</Form.Check.Label>
                  </Form.Check>
                  <Form.Check type={"radio"}>
                    <Form.Check.Input
                      type={"radio"}
                      name="highschool"
                      onChange={() => setLastYearCompleted(2)}
                      isValid
                      id="radio2"
                    />
                    <Form.Check.Label htmlFor="radio2">2</Form.Check.Label>
                  </Form.Check>
                  <Form.Check type={"radio"}>
                    <Form.Check.Input
                      type={"radio"}
                      name="highschool"
                      onChange={() => setLastYearCompleted(3)}
                      isValid
                      id="radio3"
                    />
                    <Form.Check.Label htmlFor="radio3">3</Form.Check.Label>
                  </Form.Check>
                  <Form.Check type={"radio"}>
                    <Form.Check.Input
                      type={"radio"}
                      name="highschool"
                      onChange={() => setLastYearCompleted(4)}
                      isValid
                      id="radio4"
                    />
                    <Form.Check.Label htmlFor="radio4">4</Form.Check.Label>
                  </Form.Check>
                </div>
              </Form.Label>
            </Form.Group>
