          ...
          >
            ...
            <Form.Group className="mb-3">
              <Form.Label className="Radio_btns">
                ...
                {RadioMaker("highschool" , setLastYearCompleted , 2 ,"highschool1" ,1 )}
                {RadioMaker("highschool" , setLastYearCompleted , 3 ,"highschool1" ,1 )}
                {RadioMaker("highschool" , setLastYearCompleted , 4 ,"highschool1" ,1 )}
