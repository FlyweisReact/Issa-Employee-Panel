        ...
        <div className="top-div-personal2">
          <Form id="form-appendix" className="employee1">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" placeholder="Enter  text"  onChange={(e) => setToday(e.target.value)} />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  <Form.Check  onChange={(e) => setToday(e.target.value)} type={"radio"} id={`check-api-night-sweats-no`}>
                    <Form.Check.Input
                      name="nightSweats"
                      type={"radio"}
                      isValid
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" placeholder=" ________$"   onChange={(e) => setToday(e.target.value)}/>
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label> Date available to start</Form.Label>
              <Form.Control type="date" placeholder=" ________$"  onChange={(e) => setToday(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
