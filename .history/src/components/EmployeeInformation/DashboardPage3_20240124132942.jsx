...
const DashboardPage3 = () => {
  ...
  const [from, setFrom] = useState("date_value");
  const [to, setTo] = useState("date_value");
  const [jobTitle, setJobTitle] = useState("value_or_variable_for_jobTitle");
  const [dutiesPerformed, setDutiesPerformed] = useState("value_or_variable_for_dutiesPerformed");
  const [reasonForLeaving, setReasonForLeaving] = useState("value_or_variable_for_reasonForLeaving");
  const [mayContactWithEmployee, setMayContactWithEmployee] = useState(true);
