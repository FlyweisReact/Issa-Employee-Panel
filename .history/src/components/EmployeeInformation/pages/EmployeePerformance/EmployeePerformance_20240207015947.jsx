...
const EmployeePerformance = () => {
  ...
  const [employeeDate, setEmployeeDate] = useState("2023-12-21");
  const [employeeJobTitle, setEmployeeJobTitle] = useState("Job Title");
  const [employeeManager, setEmployeeManager] = useState("Manager Name");
  const [typeOfReview, setTypeOfReview] = useState("");
  const [employeeHireDate, setEmployeeHireDate] = useState("2022-01-01");
  const [
  ...
  const [evaluation, setEvaluation] = useState(
    "Employee performance was excellent."
  );
  const [additionalComments, setAdditionalComments] = useState(
    "Additional comments for the review."
  );
