...
const EmployeePerformance = () => {
  ...
  const payload = {
    ...
    ratingsPerformanceAndQualityOfWork ,ratingsCommunication  ,ratingsProfessionalism ,ratingsAttendanceAndPunctuality ,ratingsTimeManagement ,ratingsReliabilityDependability  ,overallRating 
  };
