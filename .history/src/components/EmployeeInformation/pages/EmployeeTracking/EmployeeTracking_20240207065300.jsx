...
const EmployeeTracking = () => {
  ...
  fd.append("FingerprintClearanceCard");
  fd.append("InfectiousControlTraining");
  fd.append("TBAnnualEducation");
  fd.append("FallPreventionandFallRecovery");
  fd.append("APSSearch");
  fd.append("CPIPreventionandControl");
  fd.append("Annualabuseandneglecttraining");
  fd.append("vacationPersonalTimeUsed");
