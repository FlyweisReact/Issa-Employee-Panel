...
const EmployeeTracking = () => {
  ...
  const payload = {
    employeeId ,
    employeeSignature ,
    CPRFirstAid , TBTestChestXray , TBtestQuestionnaire , FingerprintClearanceCard , InfectiousControlTraining , TBAnnualEducation , FallPreventionandFallRecovery , APSSearch  , CPIPreventionandControl 
  }
