      ...
      <div>
        <Container className="full-width-container">
          <form className="employee1">
            ...
            <DefaultInput value={details?.data?.dose} isBots={true} label="Dose:" />
            ...
            <DefaultInput
              ...
              label="Date:"
            />
            <DefaultInput value={details?.data?.shift} isBots={true} label="Shift:" />

            <DefaultInput
              value={details?.data?.painLevel}
              isBots={true}
              label="Pain Lavel:"
            />
            <DefaultInput
              value={details?.data?.numberOfTabsGiven}
              isBots={true}
              label="Number of Tab given:"
            />
            <DefaultInput
              value={details?.data?.beginningCount}
              isBots={true}
              label="Beginning Count:"
            />

            <DefaultInput
              value={details?.data?.endingCount}
              isBots={true}
              label="Ending Count:"
            />
