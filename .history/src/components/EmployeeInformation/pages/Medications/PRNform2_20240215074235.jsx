      ...
      <Container className="full-width-container">
        <form className="employee1">
          <SelectMaker
            ...
            value={patientId}
          />
         <InputMaker label={"  Medication and Strength"} setState={setMedicationAndStrength} placeholder={} type={} value={medicationAndStrength} />
          ...
          >
            ...
            <Form.Control
              ...
              placeholder="Enter text"
              onChange={(e) =>
                handleInputChange("medicationAndStrength", e.target.value)
              }
            />
          </Form.Group>
