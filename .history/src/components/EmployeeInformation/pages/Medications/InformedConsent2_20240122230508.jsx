  ...
  return (
    ...
    <div className="nav-wrap-personal">
      ...
      <div>
        ...
        <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>Patient Name</Form.Label>
      ...
      <Form.Group style={{ fontWeight: "bold", fontSize: ".9rem" }} className="mb-3" controlId="formBasicDOB">
        ...
        <Form.Control type="date" placeholder="Enter text" onChange={(e) => handleInputChange('dob', e.target.value)} />
      </Form.Group>
        ...
        <Form.Control type="date" placeholder="Enter text" onChange={(e) => handleInputChange('admitDate', e.target.value)} />
         ...
         <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}> I,the resident/Gurdian have recieved instruction in the use of above listed medications(s) inclding the med</Form.Label>
          ...
          <Form.Group className="mb-3 ">
            ...
            <Form.Control   onChange={(e)=>setMedicationData({...medicationData, 
                staff:{name:e.target.value}})}  type="text" name="medicationsDate"  placeholder="Enter text" />
          </Form.Group>
          <Form.Group className="mb-3 ">
            <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>
            Staff Initials
            ...
            <Form.Control 
            onChange={(e)=>setMedicationData({...medicationData, 
                staff:{initials:e.target.value}})} 
             type="text" name="medicationsDate"  placeholder="Enter text" />
          </Form.Group>
