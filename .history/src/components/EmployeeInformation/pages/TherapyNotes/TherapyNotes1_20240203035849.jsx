...
import { MultiSelect, InputMaker, TextareaMaker } from "../../../../Helper/Makers";
import { Topics } from "../../../../Constant/Constant";
      ...
      <div>
        <div className="top-div-personal">
          <Form className="w-100 text-start" onSubmit={submitHandler}>
            ...
            <p style={{ textAlign: "center", margin: 0, fontWeight: "900" }}>
              Session Summary
            </p>
            <Form.Group className="mb-3 ">
              <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>
              ...
              <TextareaMaker label={"Note Summary"} setValue={} value={} placeholder={'Enter your LThe staff presented the topic Building trust and rapport to resident and laid emphasis on how crucial it is to the various aspects of life, including personal relationships, business interactions, time in treatment and professional settings. Trust is the foundation upon which successful relationships are built, and rapport enhances communication and collaboration. orem Ipsum'} />
