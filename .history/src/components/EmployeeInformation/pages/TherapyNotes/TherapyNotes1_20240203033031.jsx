...
const TherapyNotes1 = () => {
  ...
  const [residentCompletedSession, setResidentCompletedSession] = useState(false);
  const [attitude, setAttitude] = useState(["cooperative"]);
  const [treatmentGoalsAddressed, setTreatmentGoalsAddressed] = useState(true);
  const [residentParticipation, setResidentParticipation] = useState(3);
  const [residentQuality, setResidentQuality] = useState(["Attentive"]);
  const [significantInfoNotSpecifiedAbove, setSignificantInfoNotSpecifiedAbove] = useState(false);
  const [residentAppearance, setResidentAppearance] = useState(["Neat"]);
  ...
  const [significantInfoNotSpecifiedAbove1, setSignificantInfoNotSpecifiedAbove1] = useState(false);
    ...
    <>
      ...
      <div>
        <div className="top-div-personal">
          ...
          >
            <div className="therapy-notes-multiple-radio-wb">
              <div className="main">
                ...
                <Form.Check type={"radio"}>
                  <Form.Check.Input
                    onClick={() => {
                      setSessionData({
                        ...sessionData,
                        behaviorTech: "Individual Therapy",
                      });
                    }}
                    name="behaviorTech"
                    type={"radio"}
