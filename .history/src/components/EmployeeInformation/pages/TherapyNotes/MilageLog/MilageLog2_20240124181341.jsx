      ...
      <div className="top-div-personal">
        <Form className="form-personal">
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control onChange={(e) => handleInputChange("residentInitials", e.target.value)}    type="text" placeholder="Enter   Resident Initials" />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control onChange={(e) => handleInputChange("beginningMileage", e.target.value)} type="number" placeholder="Enter   Beginning Mileage" />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control onChange={(e) => handleInputChange("endingMileage", e.target.value)} type="number" placeholder="Enter  Ending Mileage" />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>
             Total Mileage :
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control   onChange={(e) => handleInputChange("driverSignature", e.target.value)} type="text" placeholder=" Enter   Driver Signature    " />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label style={{ fontWeight: "bold", fontSize: ".9rem" }}>
             Any Issues :
            </Form.Label>
            <Form.Control onChange={(e) => handleInputChange("anyIssues", e.target.value)} type="text" placeholder="Enter   Any Issues" />
          </Form.Group>
