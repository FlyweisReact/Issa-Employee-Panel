...
const TherapyNotes1 = () => {
  ...
  const [behavioralTechnicianSignature ,setBehavioralTechnicianSignature] = useState("")
  const [behavioralTechnicianName ,setBehavioralTechnicianName] = useState("")
  const [behavioralHealthProfessionalSignature ,setBehavioralHealthProfessionalSignature] = useState("")
  const [behavioralHealthProfessionalName ,setBehavioralHealthProfessionalName] = useState("")
