...
const TherapyNotes1 = () => {
  ...
  const [ , setPleaseSpecify1] = useState("");
  ...
  const payload = {
    ...
    behaviorTech ,
    location ,
    topicId ,residentCompletedSession , treatmentGoalsAddressed ,residentParticipation ,
    residentQuality ,
    significantInfoNotSpecifiedAbove , 
    residentAppearance , residentMood , residentProgress , pleaseSpecify  , residentResponse , significantInfoNotSpecifiedAbove1 
  }
