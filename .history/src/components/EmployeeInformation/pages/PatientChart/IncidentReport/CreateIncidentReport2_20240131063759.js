...
const CreateIncidentReport2 = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      setInvestigationRecommendationsAndActions(
        item?.investigationRecommendationsAndActions
      );
    ...
    <>
      ...
      <div>
        <div className="top-div-personal">
          <Form
            onSubmit={
              detail?.data?.partTypeB === true ? editHandler : submitHandler
            }
          ...
          >
            ...
            <div className="save-as-draft-btn123">
              ...
              {detail?.data?.partTypeB === true ?{loading ? <ClipLoader color="#fff" /> : "SUBMIT"} :loading ? <ClipLoader color="#fff" /> : "SUBMIT"} }
