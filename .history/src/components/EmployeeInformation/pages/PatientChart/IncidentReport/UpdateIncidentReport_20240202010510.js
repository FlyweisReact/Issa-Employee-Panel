...
const UpdateIncidentReport = () => {
  ...
  useEffect(() => {
    if (detail) {
      ...
      setMedicationErrorsRefusedMedication(item?.medicationErrorsRefusedMedication)
      ...
      setActionsTakenFireDepartmentCalled(item?.actionsTakenFireDepartmentCalled)
      setActionsTakenPoliceCalled(item?.actionsTakenPoliceCalled)
      setActionsTakenReferredtoAdministratorRiskManagement(item?.actionsTakenReferredtoAdministratorRiskManagement)

      setActionsTakenMaintenanceCalledWorkOrderCompleted(item?.actionsTakenMaintenanceCalledWorkOrderCompleted)
      setActionsTakenOther(item?.actionsTakenMaintenanceCalledWorkOrderCompleted)
