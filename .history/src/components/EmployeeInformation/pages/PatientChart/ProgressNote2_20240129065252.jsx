...
const ProgressNote2 = () => {
  ...
  const [patientId, setPatientId] = useState("your_patient_id");
  const [residentName, setResidentName] = useState("John Doe");
  const [dateOfBirth, setDateOfBirth] = useState("1990-01-01");
  const [admitDate, setAdmitDate] = useState("2023-01-01");
  const [date, setDate] = useState("2023-12-26");
  const [shift, setShift] = useState("7am-3pm");
  const [medicationAdministrationCompleted, setMedicationAdministrationCompleted] = useState(true);
  const [assistanceInMedicationAdministrationCompleted, setAssistanceInMedicationAdministrationCompleted] = useState(false);
  const [healthAndWelfareChecksCompleted, setHealthAndWelfareChecksCompleted] = useState(true);
  const [communityLivingSupport, setCommunityLivingSupport] = useState("monitors");
  const [therapy, setTherapy] = useState([""]);
  const [mood, setMood] = useState([""]);
  const [appointment, setAppointment] = useState([""]);
  const [PCP, setPCP] = useState(false);
  const [psychiatric, setPsychiatric] = useState(true);
  ...
  const [residentRedirectedOnBehaviors, setResidentRedirectedOnBehaviors] = useState(false);
  const [awolElopement, setAwolElopement] = useState(true);
  const [noteSummary, setNoteSummary] = useState("This is a progress note summary.");
  const [bhtName, setBhtName] = useState("BHT Name");
  const [bhtSignature, setBhtSignature] = useState("BHT Signature")
