        ...
        <div className="top-div-personal">
          ...
          >
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                onChange={(e) => setFundsPropertiesUponDischarge(e.target.value)}
                required
                type="text"
                placeholder="Enter  text"
              />
            ...
            <Form.Group className="mb-3">
              <Form.Control
                onChange={(e) => setDischargePlanReferralAftercarePlan(e.target.value)}
                required
                type="text"
                placeholder="Enter  text"
              />
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                onChange={(e) => setPatientGuardianSignature(e.target.value)}
                required
                type="text"
                placeholder="Enter  text"
              />
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                onChange={(e) => setPatientGuardianSignatureDate(e.target.value)}
                required
                type="date"
                placeholder="Enter  text"
              />
            ...
            <Form.Group className="mb-3 ">
              ...
              <Form.Control
                required
                onChange={(e) => setBhpSignature(e.target.value)}
                type="text"
                placeholder="Enter  text"
              />
            </Form.Group>
