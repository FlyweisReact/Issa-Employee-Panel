            ...
            <Form.Group className="mb-3">
              ...
              >
                <Form.Check
                  ...
                  onChange={(e) =>
                    setRequiresNoAssistanceOvernightBowelMovement(e.target.value)
                  }
                  label="Requires No Assistance"
                />
                <Form.Check
                  ...
                  onChange={(e) =>
                    setSomeAssistanceNeededOvernightBowelMovement(e.target.value)
                  }
                  label="Some Assistance Needed"
                />
                <Form.Check
                  ...
                  onChange={(e) =>
                    setCompleteAssistanceNeededOvernightBowelMovement(e.target.value)
                  }
                  label="Complete Assistance Needed"
                />
                <Form.Check
              ...
              <Form.Control
                onChange={(e) =>
                    setStaffInitialsOvernightBowelMovement("overnightBowelMovement", {
