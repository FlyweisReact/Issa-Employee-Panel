...
const EditAdl = () => {
  ...
  const [ clothRequiresNoAssistance , setClothRequiresNoAssistance ] = useState("")
  const [ clothSomeAssistanceNeeded ,setClothSomeAssistanceNeeded ] = useState("")
  const [ clothCompleteAssistanceNeeded , setClothCompleteAssistanceNeeded ] = useState("")
  const [ clothnotApplicable , setclothnotApplicable ] = useState("")
  const [ clothrefused , setclothrefused ] = useState("")
  const [ clothstaffInitials , setclothstaffInitials ] = useState("")


  const [ bathrequiresNoAssistance , setbathrequiresNoAssistance ] = useState("")
  const [ bathsomeAssistanceNeeded ,setbathsomeAssistanceNeeded ] = useState("")
  const [ bathcompleteAssistanceNeeded , setbathcompleteAssistanceNeeded ] = useState("")
  const [ bathnotApplicable , setbathnotApplicable ] = useState("")
  const [ bathrefused , setbathrefused ] = useState("")
  const [ bathstaffInitials , setbathstaffInitials ] = useState("")

  const [ combrequiresNoAssistance ,setcombrequiresNoAssistance ] = useState("")
  const [ combsomeAssistanceNeeded , setcombsomeAssistanceNeeded ] = useState("")
  const [ combcompleteAssistanceNeeded , setcombcompleteAssistanceNeeded ] = useState("")
  const [ combnotApplicable ,setcombnotApplicable ] = useState("")
  const [ combrefused ,setcombrefused ] = useState("")
  const [ combstaffInitials , setcombstaffInitials ] = useState("")

  const [ lotionrequiresNoAssistance ,setlotionrequiresNoAssistance ] = useState("")
  const [ lotionsomeAssistanceNeeded , setlotionsomeAssistanceNeeded ] = useState("")
  const [ lotioncompleteAssistanceNeeded ,setlotioncompleteAssistanceNeeded ] = useState("")
  const [ lotionnotApplicable , setlotionnotApplicable ] = useState("")
  const [lotionrefused ,setlotionrefused ] = useState("")
  const [ lotionstaffInitials, setlotionstaffInitials ] = useState("")

  const [ laundryrequiresNoAssistance , setlaundryrequiresNoAssistance  ] = useState("")
  const [ laundrysomeAssistanceNeeded , setlaundrysomeAssistanceNeeded  ] = useState("")
  const [   ] = useState("")
  const [   ] = useState("")
  const [   ] = useState("")
  const [   ] = useState("")
