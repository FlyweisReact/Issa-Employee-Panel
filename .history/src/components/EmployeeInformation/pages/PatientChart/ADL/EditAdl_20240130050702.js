  ...
  useEffect(() => {
    if (res) {
      ...
      setCompleteAssistanceNeededLunch(
        item?.lunch?.completeAssistanceNeeded
      );
      ...
      setCompleteAssistanceNeededDinner(
        item?.dinner?.completeAssistanceNeeded
      );
      ...
      // -----
      setRequiresNoAssistanceOvernightBowelMovement(item?.pmBowelMovement?.requiresNoAssistance);
      setSomeAssistanceNeededOvernightBowelMovement(item?.pmBowelMovement?.someAssistanceNeeded);
      setCompleteAssistanceNeededOvernightBowelMovement(
        item?.pmBowelMovement?.completeAssistanceNeeded
      );
      setNotApplicableOvernightBowelMovement(item?.pmBowelMovement?.notApplicable);
      setRefusedOvernightBowelMovement(item?.pmBowelMovement?.refused);
      setStaffInitialsOvernightBowelMovement(item?.pmBowelMovement?.staffInitials);
