            ...
            <Form.Group className="mb-3">
              ...
              >
                ...
                <Form.Check
                  ...
                  onChange={(e) =>
                    setCompleteAssistanceNeededBathingOrShowering(e.target.value)
                  }
                  label="Complete Assistance Needed"
                />
                <Form.Check
                ...
                <Form.Check
                  ...
                  onChange={(e) =>
                    setRefusedBathingOrShowering(e.target.value)
                  }
                  label="Refused"
                />
              </div>
              ...
              <Form.Control
                type="text"
                value={}
                onChange={(e) => setStaffInitialsBathingOrShowering(e.target.value)}
                required
                placeholder="Enter name"
              />
            </Form.Group>
