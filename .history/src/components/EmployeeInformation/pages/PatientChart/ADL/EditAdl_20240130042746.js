            ...
            <Form.Group className="mb-3">
              ...
              >
                ...
                <Form.Check
                  ...
                  onChange={(e) =>
                    setNotApplicableAMSnack(e.target.value)
                  }
                  label="Not Applicable"
                />
                <Form.Check
                  ...
                  onChange={(e) =>
                    setRefusedAMSnack(e.target.value)
                  }
                  label="Refused"
                />
              </div>
              ...
              <Form.Control
                type="text"
                onChange={(e) =>
                  setStaffInitialsAMSnack(e.target.value)
                }
                required
            ...
            <Form.Group className="mb-3">
              ...
              >
                ...
                <Form.Check
                  ...
                  onChange={(e) =>
                    setRefusedAMBowelMovement(e.target.value)
                  }
                  label="Refused"
                />
              </div>
              ...
              <Form.Control
                onChange={(e) =>
                  setStaffInitialsAMBowelMovement("amBowelMovement", {
