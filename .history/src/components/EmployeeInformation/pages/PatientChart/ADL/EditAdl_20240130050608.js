...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      // -----
      setRequiresNoAssistancePMBowelMovement(item?.amBowelMovement?.requiresNoAssistance);
      setSomeAssistanceNeededPMBowelMovement(item?.amBowelMovement?.someAssistanceNeeded);
      setCompleteAssistanceNeededPMBowelMovement(
        item?.amBowelMovement?.completeAssistanceNeeded
      );
      setNotApplicablePMBowelMovement(item?.amBowelMovement?.notApplicable);
      setRefusedPMBowelMovement(item?.amBowelMovement?.refused);
      setStaffInitialsPMBowelMovement(item?.amBowelMovement?.staffInitials);
