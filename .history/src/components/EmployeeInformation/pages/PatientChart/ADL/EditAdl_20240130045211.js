...
const EditAdl = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    editApi(setLoading, `employee/editADLTrackingFormById/${id}`, initialFormData);
  };
  ...
  useEffect(() => {
    if (res) {
      ...
      setNotApplicableSelectingClothes(
        item?.selectingClothes?.notApplicable
      );
      setRefusedSelectingClothes(
        item?.selectingClothes?.refused
      );
      setStaffInitialsSelectingClothes(
        item?.selectingClothes?.staffInitials
      );
      ...
      setRefusedBathingOrShowering(
        item?.bathingOrShowering?.refused
      );
      ...
      setNotApplicableCombingHair(
        item?.combingHair?.notApplicable
      );
      setRefusedCombingHair(
        item?.combingHair?.refused
      );
      setStaffInitialsCombingHair(
        item?.combingHair?.staffInitials
      );
