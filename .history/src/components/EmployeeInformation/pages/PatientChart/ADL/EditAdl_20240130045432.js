  ...
  useEffect(() => {
    if (res) {
     ...
     setRequiresNoAssistanceApplyingLotion(
      ...
      setNotApplicableLaundry(item?.applyingLotion?.notApplicable);
      setRefusedLaundry(item?.applyingLotion?.refused);
      setStaffInitialsLaundry(item?.applyingLotion?.staffInitials);
