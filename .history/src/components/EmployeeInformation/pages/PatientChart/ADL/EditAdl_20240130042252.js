            ...
            <Form.Group className="mb-3">
              ...
              >
                <Form.Check
                  ...
                  onChange={(e) =>
                    setRequiresNoAssistanceLunch(e.target.value)
                  }
                  label="Requires No Assistance"
                />
                <Form.Check
                  ...
                  onChange={(e) =>
                    setSomeAssistanceNeededLunch(e.target.value)
                  }
                  label="Some Assistance Needed"
                />
                <Form.Check
                ...
                <Form.Check
                  ...
                  onChange={(e) =>
                    setNotApplicableLunch(e.target.value)
                  }
                  label="Not Applicable"
                />
                <Form.Check
                  ...
                  value={!refusedLunch}
                  onChange={(e) =>
                    setRefusedLunch(e.target.value)
                  }
                  label="Refused"
                />
              </div>
              ...
              <Form.Control
                type="text"
                onChange={(e) =>
                    setStaffInitialsLunch( e.target.value)
                }
                required
                placeholder="Enter name"
              />
