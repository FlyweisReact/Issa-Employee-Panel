...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      // -----
      setRequiresNoAssistanceAMSnack(item?.dinner?.requiresNoAssistance);
      setSomeAssistanceNeededAMSnack(item?.dinner?.someAssistanceNeeded);
      setCompleteAssistanceNeededAMSnack(
        item?.dinner?.completeAssistanceNeeded
      );
      setNotApplicableAMSnack(item?.dinner?.notApplicable);
      setRefusedAMSnack(item?.dinner?.refused);
      setStaffInitialsAMSnack(item?.dinner?.staffInitials);
