...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      // -----
      setRequiresNoAssistanceAMBowelMovement(item?.pmSnack?.requiresNoAssistance);
      setSomeAssistanceNeededAMBowelMovement(item?.pmSnack?.someAssistanceNeeded);
      setCompleteAssistanceNeededAMBowelMovement(
        item?.pmSnack?.completeAssistanceNeeded
      );
      setNotApplicableAMBowelMovement(item?.pmSnack?.notApplicable);
      setRefusedAMBowelMovement(item?.pmSnack?.refused);
      setStaffInitialsAMBowelMovement(item?.pmSnack?.staffInitials);
