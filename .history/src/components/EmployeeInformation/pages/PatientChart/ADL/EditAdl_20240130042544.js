            ...
            <Form.Group className="mb-3">
              ...
              >
                ...
                <Form.Check
                  ...
                  onChange={(e) =>
                    setNotApplicableBreakfast(e.target.value)
                  }
                  label="Not Applicable"
                />
                <Form.Check
              ...
              <Form.Control
                type="text"
                onChange={(e) =>
                    setStaffInitialsBreakfast(e.target.value)
                }
                required
            ...
            <Form.Group className="mb-3">
              ...
              >
                ...
                <Form.Check
                  ...
                  onChange={(e) =>
                    setNotApplicableDinner(e.target.value)
                  }
                  label="Not Applicable"
                />
                <Form.Check
                  ...
                  value={!refusedDinner}
                  onChange={(e) =>
                    setRefusedDinner(e.target.value)
                  }
                  label="Refused"
                />
              </div>
              ...
              <Form.Control
                type="text"
                onChange={(e) =>
                    setStaffInitialsDinner(e.target.value)
                }
                required
                placeholder="Enter name"
              />
