...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      // -----
      setRequiresNoAssistanceDinner(item?.lunch?.requiresNoAssistance);
      setSomeAssistanceNeededDinner(item?.lunch?.someAssistanceNeeded);
      setCompleteAssistanceNeededDinner(
        item?.lunch?.completeAssistanceNeeded
      );
      setNotApplicableDinner(item?.lunch?.notApplicable);
      setRefusedDinner(item?.lunch?.refused);
      setStaffInitialsDinner(item?.lunch?.staffInitials);
