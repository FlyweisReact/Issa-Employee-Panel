...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      // -----
      setRequiresNoAssistanceBreakfast(item?.oralCareEvening?.requiresNoAssistance);
      setSomeAssistanceNeededBreakfast(item?.oralCareEvening?.someAssistanceNeeded);
      setCompleteAssistanceNeededBreakfast(
        item?.oralCareEvening?.completeAssistanceNeeded
      );
      setNotApplicableBreakfast(item?.oralCareEvening?.notApplicable);
      setRefusedBreakfast(item?.oralCareEvening?.refused);
      setStaffInitialsBreakfast(item?.oralCareEvening?.staffInitials);
