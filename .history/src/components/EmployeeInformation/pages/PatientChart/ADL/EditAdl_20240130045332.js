...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      setNotApplicableApplyingLotion(item?.combingHair?.notApplicable);
      setRefusedApplyingLotion(item?.combingHair?.refused);
      setStaffInitialsApplyingLotion(item?.combingHair?.staffInitials);
    }
  }, [res]);
