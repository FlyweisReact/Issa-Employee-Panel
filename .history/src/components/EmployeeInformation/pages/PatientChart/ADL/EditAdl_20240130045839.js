...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      // -----
      setRequiresNoAssistanceOralCareMorning(item?.shampooingHair?.requiresNoAssistance);
      setSomeAssistanceNeededOralCareMorning(item?.shampooingHair?.someAssistanceNeeded);
      setCompleteAssistanceNeededOralCareMorning(
        item?.shampooingHair?.completeAssistanceNeeded
      );
      setNotApplicableOralCareMorning(item?.shampooingHair?.notApplicable);
      setRefusedOralCareMorning(item?.shampooingHair?.refused);
      setStaffInitialsOralCareMorning(item?.shampooingHair?.staffInitials);
