...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      // -----
      setRequiresNoAssistanceShampooingHair(item?.dressing?.requiresNoAssistance);
      setSomeAssistanceNeededShampooingHair(item?.dressing?.someAssistanceNeeded);
      setCompleteAssistanceNeededShampooingHair(
        item?.dressing?.completeAssistanceNeeded
      );
      setNotApplicableShampooingHair(item?.dressing?.notApplicable);
      setRefusedShampooingHair(item?.dressing?.refused);
      setStaffInitialsShampooingHair(item?.dressing?.staffInitials);
