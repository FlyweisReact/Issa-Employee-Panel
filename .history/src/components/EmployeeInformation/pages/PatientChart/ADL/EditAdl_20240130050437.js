...
const EditAdl = () => {
  ...
  useEffect(() => {
    if (res) {
      ...
      // -----
      setRequiresNoAssistancePMSnack(item?.amSnack?.requiresNoAssistance);
      setSomeAssistanceNeededPMSnack(item?.amSnack?.someAssistanceNeeded);
      setCompleteAssistanceNeededPMSnack(
        item?.amSnack?.completeAssistanceNeeded
      );
      setNotApplicablePMSnack(item?.amSnack?.notApplicable);
      setRefusedPMSnack(item?.amSnack?.refused);
      setStaffInitialsPMSnack(item?.amSnack?.staffInitials);
