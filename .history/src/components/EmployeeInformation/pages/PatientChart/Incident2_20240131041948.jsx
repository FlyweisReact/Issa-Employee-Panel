...
const Incident2 = () => {
  ...
  const [patientId, setPatientId] = useState("6572c1ffd4a09e03c1c57f50");
  const [dateOfIncident, setDateOfIncident] = useState("2023-12-06");
  const [timeOfIncident, setTimeOfIncident] = useState("12:30 PM");
  ...
  const [personObservingReporting, setPersonObservingReporting] =
  ...
  const [abuseNeglectInvolved, setAbuseNeglectInvolved] = useState(true);
  const [abuseNeglectInvolvedifYes, setAbuseNeglectInvolvedifYes] =
    useState("Explanation...");
  const [notificationsFamily, setNotificationsFamily] = useState(true);
  ...
  const [notificationDate, setNotificationDate] = useState("2023-12-06");
  const [notificationTime, setNotificationTime] = useState("02:00 PM");
  const [reportCompletedBy, setReportCompletedBy] = useState("Reporter Name");
