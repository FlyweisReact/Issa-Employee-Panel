...
const EditProgressNote = () => {
  ...
  useEffect(() => {
    if(response){
        ...
        setAssistanceInMedicationAdministrationCompleted(item?.assistanceInMedicationAdministrationCompleted)
        setMedicationAdministrationCompleted(item?.medicationAdministrationCompleted)
    }   
  },[response])
