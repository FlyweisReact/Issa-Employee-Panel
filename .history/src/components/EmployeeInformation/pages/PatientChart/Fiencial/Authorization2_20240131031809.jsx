...
const Authorization2 = () => {
  ...
  const submitHandler = async  (e) => {
    e.preventDefault();
 await   postData("employee/createAuthorizationForReleaseOfInformation", payload);
  ...
  return (
    <>
    <SignatureModal show={open} onHide={() => setOpen(false)} text={"Digitally Sign by employee name "} setValue={setSignature } value={sing}  />
      ...
      <div>
        <div className="top-div-personal">
          ...
          <div className="mixed_input mb-3">
            ...
            <span>
              <input type="text" onChange={(e) => setSpecify(e.target.value)} />{" "}
            </span>
