      ...
      <div>
        <div className="top-div-personal">
          ...
          <div className="mixed_input">
            ...
            taken. This authorization for release of information will expire: <br />
            <span>
              <input type='text' onChange={(e) => setExpirationTo(e.target.value)} requires  />
            </span>
             One year from date _____ 60 Days (Substance Abuse Services)
            _____ Other (specify)
            __________________________________________________________ By
            signing below, I acknowledge that I have read and understand this
