    ...
    <>
      ...
      <Container className="full-width-container">
        <Form className="w-100 text-start">
          ...
          <Form.Group className="mb-3">
            <Form.Label style={{ fontWeight: "bold", fontSize: "14px" }}>PROGRESS:</Form.Label>
            <Form.Control value={details?.data?.progress} />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label style={{ fontWeight: "bold", fontSize: "14px" }}>BARRIER(S):</Form.Label>
            <Form.Control value={details?.data?.barriers} />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label style={{ fontWeight: "bold", fontSize: "14px" }}>RECOMMENDATIONS:</Form.Label>
