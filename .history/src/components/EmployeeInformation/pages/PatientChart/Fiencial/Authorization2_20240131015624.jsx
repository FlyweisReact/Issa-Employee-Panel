        ...
        <div className="top-div-personal">
          ...
          <Form.Group className="mb-3 ">
            ...
            />
                ...
                Authorize
                 <input type='text' required onChange={(e) => setAuthorizedPersonName(e.target)} />
                </div>
          <p style={{ fontWeight: "bold" }}>
            ...
            <input
              ...
              placeholder="__EMPLOYEE NAME_____"
            />{" "}
