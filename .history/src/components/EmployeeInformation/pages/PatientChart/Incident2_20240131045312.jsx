...
import { CheckBoxMaker, InputMaker, MultiSelect } from "../../../../Helper/Makers";
import {
  incidentOptions,
        ...
        <div className="top-div-personal">
          <Form className="w-100 text-start">
            ...
            <Form.Group className="mb-3 ">
              ...
              >
              <CheckBoxMaker setValue={setMedicationErrorsMissedDose} value={!medicationErrorsMissedDose} label='Missed Dose' checked={med}   />
                <Form.Check
