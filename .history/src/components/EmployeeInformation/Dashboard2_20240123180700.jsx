                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  >
                    <Form.Check.Input
                      ...
                      type={"radio"}
                      isValid
                      checked={underAgee18 === "true"} // or use === true if underAgee18 is a boolean
                      onChange={() => setUnderAgee18("true")} // or setUnderAgee18(true) if underAgee18 is a boolean
                    />
                    <Form.Check.Label
                      style={{
                        marginLeft: "5px",
                  ...
                  <Form.Check type={"radio"} id={`check-api-night-sweats-no`}>
                    <Form.Check.Input
                      ...
                      type={"radio"}
                      isValid
                      checked={underAgee18 === "false"} // or use === false if underAgee18 is a boolean
                      onChange={() => setUnderAgee18("false")} // or setUnderAgee18(false) if underAgee18 is a boolean
                    />
