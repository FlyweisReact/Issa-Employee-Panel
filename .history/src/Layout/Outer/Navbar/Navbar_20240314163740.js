  ...
  return (
    <>
      ...
      <div
        className={
          hamb
            ? "flex  w-full justify-between  mt-1 rounded-sm  p-4 py-1 shadow-md items-center  space-x-4 Main_Nav mb-3"
            : "flex  w-full justify-between mt-1 mb-3 rounded-sm  p-4 py-1 shadow-md items-center   space-x-4 Main_Nav"
        }
      >
